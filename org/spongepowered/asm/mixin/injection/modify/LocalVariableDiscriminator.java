...
public class LocalVariableDiscriminator {
    ...
    private int findImplicitLocal(LocalVariableDiscriminator.Context context) {
        ...
        if (count == 1) {
            ...
            throw new InvalidImplicitDiscriminatorException(
                "Found " + count + " candidate variables but exactly 1 is required."
            );
        }
    }
    ...
    public static class Context implements PrettyPrinter.IPrettyPrintable {
        ...
        private LocalVariableDiscriminator.Context.Local[] initLocals(
            Target target, boolean argsOnly, AbstractInsnNode node
        ) {
            if (!argsOnly) {
                ...
                if (locals != null) {
                    ...
                    for (int l = 0; l < locals.length; l++) {
                        if (locals[l] != null) {
                            lvt[l] = new LocalVariableDiscriminator.Context.Local(
                                locals[l].name, Type.getType(locals[l].desc)
                            );
                        }
                    }
            ...
            LocalVariableDiscriminator.Context.Local[] lvt = new LocalVariableDiscriminator.Context.Local[this.baseArgIndex
            ...
            for (int l = this.baseArgIndex; l < this.locals.length; l++) {
                ...
                if (local != null) {
                    ...
                    printer.add(
                        ...
                        l,
                        ordinal,
                        SignaturePrinter.getTypeName(localType, false),
                        localName,
                        candidate
                    );
                } else if (l > 0) {
