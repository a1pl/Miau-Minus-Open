...
public class BeforeInvoke extends InjectionPoint {
    ...
    public boolean find(String desc, InsnList insns, Collection<AbstractInsnNode> nodes) {
        ...
        if (!this.find(desc, insns, nodes, this.target, BeforeInvoke.SearchType.STRICT)
            && this.target.desc != null
            && this.allowPermissive) {
            this.logger
                .warn(
    ...
    protected boolean find(
        ...
        MemberInfo target = searchType == BeforeInvoke.SearchType.PERMISSIVE ? member.transform(null) : member;
        int ordinal = 0;
        int found = 0;
        ...
        if (searchType == BeforeInvoke.SearchType.PERMISSIVE && found > 1) {
            this.logger
                .warn(
                    ...
                    new Object[]{this.className, member, this.context, found}
                );
        }
