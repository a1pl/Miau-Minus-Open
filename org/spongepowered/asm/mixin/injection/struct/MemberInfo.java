...
public final class MemberInfo {
    ...
    public String toCtorDesc() {
        return this.desc != null && this.desc.startsWith("(") && this.desc.indexOf(41) > -1
            ? this.desc.substring(0, this.desc.indexOf(41) + 1) + "V"
            : null;
    }
    ...
    public String getReturnType() {
        if (this.desc != null && this.desc.indexOf(41) != -1 && this.desc.indexOf(40) == 0) {
            ...
            return returnType.startsWith("L") && returnType.endsWith(";")
                ? returnType.substring(1, returnType.length() - 1)
                : returnType;
        } else {
            return null;
        }
        ...
        if (this.isField()) {
            ...
            try {
                ...
                if (!retString.equals(retType.getDescriptor())) {
                    throw new InvalidMemberDescriptorException(
                        "Invalid return type \"" + retString + "\" in descriptor: " + this.desc
                    );
                } else {
                    return this;
                }
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj.getClass() == MemberInfo.class) {
            ...
            return this.matchAll == other.matchAll
                && this.forceField == other.forceField
    ...
    public MemberInfo move(String newOwner) {
        return (newOwner != null || this.owner != null) && (newOwner == null || !newOwner.equals(this.owner))
            ? new MemberInfo(this, newOwner)
            : this;
    }
