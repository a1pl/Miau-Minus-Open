...
public class MethodNode extends MethodVisitor {
        ...
        this.instructions
            .add(
                new FrameNode(
                    type,
                    nLocal,
                    local == null ? null : this.getLabelNodes(local),
                    nStack,
                    stack == null ? null : this.getLabelNodes(stack)
                )
            );
    }
        ...
        this.tryCatchBlocks
            .add(
                new TryCatchBlockNode(
                    this.getLabelNode(start), this.getLabelNode(end), this.getLabelNode(handler), type
                )
            );
    }
    ...
    public void visitLocalVariable(String name, String desc, String signature, Label start, Label end, int index) {
        this.localVariables
            .add(new LocalVariableNode(name, desc, signature, this.getLabelNode(start), this.getLabelNode(end), index));
    }
    ...
    public AnnotationVisitor visitLocalVariableAnnotation(
        ...
        LocalVariableAnnotationNode an = new LocalVariableAnnotationNode(
            typeRef, typePath, this.getLabelNodes(start), this.getLabelNodes(end), index, desc
        );
        if (visible) {
    ...
    public void accept(MethodVisitor mv) {
        ...
        for (int var18 = 0; var18 < n; var18++) {
            AnnotationNode an = this.visibleAnnotations.get(var18);
        ...
        for (int var19 = 0; var19 < n; var19++) {
            AnnotationNode an = this.invisibleAnnotations.get(var19);
        ...
        for (int var20 = 0; var20 < n; var20++) {
            TypeAnnotationNode an = this.visibleTypeAnnotations.get(var20);
        ...
        for (int var21 = 0; var21 < n; var21++) {
            TypeAnnotationNode an = this.invisibleTypeAnnotations.get(var21);
        ...
        for (int var24 = 0; var24 < n; var24++) {
            mv.visitAttribute(this.attrs.get(var24));
        }
        ...
        if (this.instructions.size() > 0) {
            ...
            for (int var25 = 0; var25 < n; var25++) {
                this.tryCatchBlocks.get(var25).updateIndex(var25);
                this.tryCatchBlocks.get(var25).accept(mv);
            }
