...
public class Analyzer<V extends Value> implements Opcodes {
                    ...
                    if (insnNode instanceof JumpInsnNode) {
                        ...
                        for (int i = 0; i < subroutine.callers.size(); i++) {
                            ...
                            if (this.frames[call] != null) {
                                this.merge(
                                    call + 1, this.frames[call], current, this.subroutines[call], subroutine.access
                                );
    ...
    private void merge(
        int insn, Frame<V> beforeJSR, Frame<V> afterRET, Subroutine subroutineBeforeJSR, boolean[] access
