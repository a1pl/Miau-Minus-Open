...
public class SimpleVerifier extends BasicVerifier {
    ...
    public SimpleVerifier(
        Type currentClass, Type currentSuperClass, List<Type> currentClassInterfaces, boolean isInterface
    ) {
        this(327680, currentClass, currentSuperClass, currentClassInterfaces, isInterface);
    }

    protected SimpleVerifier(
        int api, Type currentClass, Type currentSuperClass, List<Type> currentClassInterfaces, boolean isInterface
    ) {
        super(api);
    ...
    public BasicValue merge(BasicValue v, BasicValue w) {
        ...
        Type u = w.getType();
        if (t != null
            && (t.getSort() == 10 || t.getSort() == 9)
            && u != null
            && (u.getSort() == 10 || u.getSort() == 9)) {
    ...
    protected boolean isInterface(Type t) {
        return this.currentClass != null && t.equals(this.currentClass)
            ? this.isInterface
            : this.getClass(t).isInterface();
    }
        ...
        if (this.currentClass != null && t.equals(this.currentClass)) {
            if (this.getSuperClass(u) == null) {
                ...
                return !this.isInterface
                    ? this.isAssignableFrom(t, this.getSuperClass(u))
                    : u.getSort() == 10 || u.getSort() == 9;
            }
    ...
    protected Class<?> getClass(Type t) {
        try {
            return t.getSort() == 9
                ? Class.forName(t.getDescriptor().replace('/', '.'), false, this.loader)
                : Class.forName(t.getClassName(), false, this.loader);
