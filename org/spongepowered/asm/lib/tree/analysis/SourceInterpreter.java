...
public class SourceInterpreter extends Interpreter<SourceValue> implements Opcodes {
    ...
    public SourceValue ternaryOperation(
        AbstractInsnNode insn, SourceValue value1, SourceValue value2, SourceValue value3
    ) {
    ...
    public SourceValue merge(SourceValue d, SourceValue w) {
        if (d.insns instanceof SmallSet && w.insns instanceof SmallSet) {
            Set<AbstractInsnNode> s = ((SmallSet)d.insns).union((SmallSet<AbstractInsnNode>)w.insns);
