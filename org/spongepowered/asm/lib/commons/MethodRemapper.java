...
public class MethodRemapper extends MethodVisitor {
    ...
    public void visitFieldInsn(int opcode, String owner, String name, String desc) {
        super.visitFieldInsn(
            ...
            this.remapper.mapFieldName(owner, name, desc),
        ...
        if (this.mv != null) {
            this.mv
                .visitMethodInsn(
                    opcode,
                    this.remapper.mapType(owner),
                    this.remapper.mapMethodName(owner, name, desc),
                    this.remapper.mapMethodDesc(desc),
                    itf
                );
        }
    }
    ...
    public void visitInvokeDynamicInsn(String name, String desc, Handle bsm, Object... bsmArgs) {
        ...
        super.visitInvokeDynamicInsn(
            this.remapper.mapInvokeDynamicMethodName(name, desc),
            this.remapper.mapMethodDesc(desc),
            (Handle)this.remapper.mapValue(bsm),
            bsmArgs
        );
    }
    ...
    public void visitLocalVariable(String name, String desc, String signature, Label start, Label end, int index) {
        super.visitLocalVariable(
            name, this.remapper.mapDesc(desc), this.remapper.mapSignature(signature, true), start, end, index
        );
    }
    ...
    public AnnotationVisitor visitLocalVariableAnnotation(
        ...
        AnnotationVisitor av = super.visitLocalVariableAnnotation(
            typeRef, typePath, start, end, index, this.remapper.mapDesc(desc), visible
        );
        return av == null ? av : new AnnotationRemapper(av, this.remapper);
    }
}
