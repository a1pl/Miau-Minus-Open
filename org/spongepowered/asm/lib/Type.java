...
public class Type {
    ...
    public static Type getType(Class<?> c) {
        if (c.isPrimitive()) {
            if (c == int.class) {
                ...
                return c == float.class ? FLOAT_TYPE : LONG_TYPE;
            }
        } else {
    ...
    public int getOpcode(int opcode) {
        return opcode != 46 && opcode != 79
            ? opcode + (this.buf == null ? (this.off & 0xFF0000) >> 16 : 4)
            : opcode + (this.buf == null ? (this.off & 0xFF00) >> 8 : 4);
    }
