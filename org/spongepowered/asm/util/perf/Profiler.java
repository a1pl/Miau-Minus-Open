...
public final class Profiler {
            ...
            for (Profiler.Section next = head; next != section; next = this.stack.pop()) {
                if (next == null && this.active) {
                    ...
                    throw new IllegalStateException(
                        "Attempted to pop " + section + " which was not in the stack, head was " + head
                    );
                }
            }
    ...
    private void printSectionRow(
        PrettyPrinter printer, int colCount, int[] columns, Profiler.Section section, boolean group
    ) {
