...
public class ClassSignature {
    ...
    public static ClassSignature ofLazy(ClassNode classNode) {
        return classNode.signature != null ? new ClassSignature.Lazy(classNode.signature) : generate(classNode);
    }

    private static ClassSignature generate(ClassNode classNode) {
        ClassSignature generated = new ClassSignature();
        generated.setSuperClass(
            new ClassSignature.Token(classNode.superName != null ? classNode.superName : "java/lang/Object")
        );
