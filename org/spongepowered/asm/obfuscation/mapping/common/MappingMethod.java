...
public class MappingMethod implements IMapping<MappingMethod> {
    ...
    public MappingMethod addPrefix(String prefix) {
        ...
        return simpleName != null && !simpleName.startsWith(prefix)
            ? new MappingMethod(this.getOwner(), prefix + simpleName, this.getDesc())
            : this;
    }
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            return !(obj instanceof MappingMethod)
                ? false
                : Objects.equal(this.name, ((MappingMethod)obj).name)
                    && Objects.equal(this.desc, ((MappingMethod)obj).desc);
        }
    }
