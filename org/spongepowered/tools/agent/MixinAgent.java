    ...
    class Transformer implements ClassFileTransformer {
        ...
        private List<String> reloadMixin(String className, byte[] classfileBuffer) {
            ...
            try {
                ...
                MixinAgent.logger
                    .error(
                        "Mixin {} cannot be reloaded, needs a restart to be applied: {} ",
                        new Object[]{e.getMixinInfo(), e.getMessage()}
                    );
            } catch (Throwable th) {
        ...
        private boolean reApplyMixins(List<String> targets) {
            ...
            for (String target : targets) {
                ...
                try {
                    ...
                    targetBytecode = MixinAgent.this.classTransformer
                        .transformClassBytes(null, targetName, targetBytecode);
