...
public class CompactConstructor extends org.yaml.snakeyaml.constructor.Constructor {
    private static final Pattern GUESS_COMPACT = Pattern.compile(
    ...
    protected void applySequence(Object bean, List<?> value) {
        try {
            Property property = this.getPropertyUtils()
                .getProperty((Class<? extends Object>)bean.getClass(), this.getSequencePropertyName(bean.getClass()));
    ...
    public class ConstructCompactObject extends org.yaml.snakeyaml.constructor.Constructor.ConstructMapping {
        ...
        public void construct2ndStep(Node node, Object object) {
            ...
            if (valueNode instanceof MappingNode) {
                ...
                CompactConstructor.this.applySequence(
                    object, CompactConstructor.this.constructSequence((SequenceNode)valueNode)
                );
            }
        }
        ...
        public Object construct(Node node) {
            ...
            return data == null
                ? CompactConstructor.this.constructScalar(tmpNode)
                : CompactConstructor.this.constructCompactFormat(tmpNode, data);
        }
    }
}
