...
public class MethodProperty extends GenericProperty {
    ...
    public Object get(Object object) {
        try {
            ...
            throw new YAMLException(
                "Unable to find getter for property '" + this.property.getName() + "' on object " + object + ":" + e
            );
        }
    }
    ...
    public List<Annotation> getAnnotations() {
        ...
        if (this.isReadable() && this.isWritable()) {
            annotations = ArrayUtils.toUnmodifiableCompositeList(
                this.property.getReadMethod().getAnnotations(), this.property.getWriteMethod().getAnnotations()
            );
