...
public class ParserImpl implements Parser {
            ...
            if (token.getName().equals("YAML")) {
                ...
                if (major != 1) {
                    throw new ParserException(
                        null, null, "found incompatible YAML document (version 1.* is required)", token.getStartMark()
                    );
                }
        ...
        if (this.scanner.checkToken(Token.ID.Alias)) {
            ...
            if (indentlessSequence && this.scanner.checkToken(Token.ID.BlockEntry)) {
                ...
                event = new ScalarEvent(
                    anchor, tag, implicitValues, token.getValue(), startMark, endMark, token.getStyle()
                );
                this.state = this.states.pop();
    ...
    private Event processEmptyScalar(Mark mark) {
        return new ScalarEvent(
            null, null, new ImplicitTuple(true, false), "", mark, mark, DumperOptions.ScalarStyle.PLAIN
        );
    }
    ...
    private class ParseDocumentContent implements Production {
        ...
        public Event produce() {
            if (ParserImpl.this.scanner.checkToken(Token.ID.Comment)) {
                ...
                return ParserImpl.this.produceCommentEvent((CommentToken)ParserImpl.this.scanner.getToken());
            } else if (ParserImpl.this.scanner
                .checkToken(Token.ID.Directive, Token.ID.DocumentStart, Token.ID.DocumentEnd, Token.ID.StreamEnd)) {
                    ...
                    if (!ParserImpl.this.scanner.checkToken(Token.ID.DocumentStart)) {
                        throw new ParserException(
                            ...
                            "expected '<document start>', but found '"
                                + ParserImpl.this.scanner.peekToken().getTokenId()
                                + "'",
    ...
    private class ParseFlowMappingKey implements Production {
        ...
        public Event produce() {
            ...
            if (!ParserImpl.this.scanner.checkToken(Token.ID.FlowMappingEnd)) {
                ...
                if (ParserImpl.this.scanner.checkToken(Token.ID.Key)) {
                    Token token = ParserImpl.this.scanner.getToken();
                    if (!ParserImpl.this.scanner
                        .checkToken(Token.ID.Value, Token.ID.FlowEntry, Token.ID.FlowMappingEnd)) {
    ...
    private class ParseFlowSequenceEntry implements Production {
        ...
        public Event produce() {
            ...
            if (!ParserImpl.this.scanner.checkToken(Token.ID.FlowSequenceEnd)) {
                ...
                if (ParserImpl.this.scanner.checkToken(Token.ID.Key)) {
                    Token token = ParserImpl.this.scanner.peekToken();
                    Event event = new MappingStartEvent(
                        null, null, true, token.getStartMark(), token.getEndMark(), DumperOptions.FlowStyle.FLOW
                    );
    ...
    private class ParseImplicitDocumentStart implements Production {
        ...
        public Event produce() {
            if (ParserImpl.this.scanner.checkToken(Token.ID.Comment)) {
                ...
                .checkToken(Token.ID.Directive, Token.ID.DocumentStart, Token.ID.StreamEnd)) {
                Token token = ParserImpl.this.scanner.peekToken();
                Mark startMark = token.getStartMark();
                Mark endMark = startMark;
    ...
    private class ParseIndentlessSequenceEntryValue implements Production {
        ...
        public Event produce() {
            if (ParserImpl.this.scanner.checkToken(Token.ID.Comment)) {
                ...
                .checkToken(Token.ID.BlockEntry, Token.ID.Key, Token.ID.Value, Token.ID.BlockEnd)) {
