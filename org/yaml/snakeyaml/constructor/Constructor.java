        ...
        public Object construct(Node node) {
            ...
            if (Map.class.isAssignableFrom(node.getType())) {
                return node.isTwoStepsConstruction()
                    ? Constructor.this.newMap(mnode)
                    : Constructor.this.constructMapping(mnode);
            } else if (Collection.class.isAssignableFrom(node.getType())) {
                return node.isTwoStepsConstruction()
                    ? Constructor.this.newSet(mnode)
                    : Constructor.this.constructSet(mnode);
            } else {
                ...
                if (obj != BaseConstructor.NOT_INSTANTIATED_OBJECT) {
                    ...
                    throw new ConstructorException(
                        null, null, "Can't create an instance for " + mnode.getTag(), node.getStartMark()
                    );
                }
            }
        }
        ...
        protected Object constructJavaBean2ndStep(MappingNode node, Object object) {
            ...
            for (NodeTuple tuple : node.getValue()) {
                ...
                try {
                    ...
                    boolean typeDetected = memberDescription != null
                    ...
                    Object value = memberDescription != null
                        ? this.newInstance(memberDescription, key, valueNode)
            ...
            if (!type.isPrimitive()
                ...
                try {
                    ...
                    throw new ConstructorException(
                        null,
                        null,
                        "Can't construct a java object for scalar " + node.getTag() + "; exception=" + e.getMessage(),
                        node.getStartMark(),
                        e
                    );
                }
        ...
        public Object construct(Node node) {
            ...
            if (Set.class.isAssignableFrom(node.getType())) {
                ...
                if (Collection.class.isAssignableFrom(node.getType())) {
                    return node.isTwoStepsConstruction()
                        ? Constructor.this.newList(snode)
                        : Constructor.this.constructSequence(snode);
                }
