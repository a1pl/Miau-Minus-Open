...
public class FastNoiseLite {
    ...
    private float SingleOpenSimplex2S(int seed, float x, float y, float z) {
        ...
        float value = a0
            ...
            * a0
            * GradCoord(
                seed, i + (xNMask & 501125321), j + (yNMask & 1136930381), k + (zNMask & 1720413743), x0, y0, z0
            );
        float x1 = xi - 0.5F;
        float y1 = yi - 0.5F;
        float z1 = zi - 0.5F;
        ...
        if (a2 > 0.0F) {
            ...
            value += a2
                ...
                * a2
                * GradCoord(
                    seed, i + (~xNMask & 501125321), j + (yNMask & 1136930381), k + (zNMask & 1720413743), x2, y0, z0
                );
        } else {
            ...
            if (a4 > 0.0F) {
                ...
                value += a4
                    ...
                    * a4
                    * a4
                    * GradCoord(seed2, i + (xNMask & 1002250642), j + 1136930381, k + 1720413743, x4, y1, z1);
                skip5 = true;
            }
        }
        ...
        if (a6 > 0.0F) {
            ...
            value += a6
                ...
                * a6
                * GradCoord(
                    seed, i + (xNMask & 501125321), j + (~yNMask & 1136930381), k + (zNMask & 1720413743), x0, y6, z0
                );
        } else {
            ...
            if (a8 > 0.0F) {
                ...
                value += a8
                    ...
                    * a8
                    * a8
                    * GradCoord(seed2, i + 501125321, j + (yNMask & -2021106534), k + 1720413743, x1, y8, z1);
                skip9 = true;
            }
        }
        ...
        if (aA > 0.0F) {
            ...
            value += aA
                ...
                * aA
                * GradCoord(
                    seed, i + (xNMask & 501125321), j + (yNMask & 1136930381), k + (~zNMask & 1720413743), x0, y0, zA
                );
        } else {
            ...
            if (aC > 0.0F) {
                ...
                value += aC
                    ...
                    * aC
                    * aC
                    * GradCoord(seed2, i + 501125321, j + 1136930381, k + (zNMask & -854139810), x1, y1, zC);
                skipD = true;
            }
        }
        ...
        if (!skip5) {
            ...
            if (a5 > 0.0F) {
                ...
                value += a5
                    ...
                    * a5
                    * a5
                    * GradCoord(seed2, i + 501125321, j + (yNMask & -2021106534), k + (zNMask & -854139810), x1, y5, z5);
            }
        }
        ...
        if (!skip9) {
            ...
            if (a9 > 0.0F) {
                ...
                value += a9
                    ...
                    * a9
                    * a9
                    * GradCoord(seed2, i + (xNMask & 1002250642), j + 1136930381, k + (zNMask & -854139810), x9, y1, z9);
            }
        }
        ...
        if (!skipD) {
            ...
            if (aD > 0.0F) {
                ...
                value += aD
                    ...
                    * aD
                    * GradCoord(
                        seed2, i + (xNMask & 1002250642), j + (yNMask & -2021106534), k + 1720413743, xD, yD, z1
                    );
            }
        }
    ...
    private float SingleValueCubic(int seed, float x, float y) {
        ...
        return CubicLerp(
                CubicLerp(
                    ValCoord(seed, x0, y0), ValCoord(seed, x1, y0), ValCoord(seed, x2, y0), ValCoord(seed, x3, y0), xs
                ),
                CubicLerp(
    ...
    private void DoSingleDomainWarp(
        int seed, float amp, float freq, float x, float y, float z, FastNoiseLite.Vector3 coord
    ) {
        switch (this.mDomainWarpType) {
            case OpenSimplex2:
    ...
    private void SingleDomainWarpBasicGrid(
        int seed, float warpAmp, float frequency, float x, float y, FastNoiseLite.Vector2 coord
    ) {
    ...
    private void SingleDomainWarpBasicGrid(
        int seed, float warpAmp, float frequency, float x, float y, float z, FastNoiseLite.Vector3 coord
    ) {
        float xf = x * frequency;
        float yf = y * frequency;
    ...
    private void SingleDomainWarpSimplexGradient(
        int seed, float warpAmp, float frequency, float x, float y, FastNoiseLite.Vector2 coord, boolean outGradOnly
    ) {
        float SQRT3 = 1.7320508F;
        float G2 = 0.21132487F;
        x *= frequency;
