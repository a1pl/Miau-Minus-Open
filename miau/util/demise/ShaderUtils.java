    ...
    public ShaderUtils(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                default:
                    fragmentShaderID = this.createShader(
                        mc.func_110442_L().func_110536_a(new ResourceLocation(fragmentShaderLoc)).func_110527_b(),
                        35632
                    );
            }
            ...
            int vertexShaderID = this.createShader(
                mc.func_110442_L().func_110536_a(new ResourceLocation(vertexShaderLoc)).func_110527_b(), 35633
            );
