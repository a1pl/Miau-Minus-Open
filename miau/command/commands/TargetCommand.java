...
public class TargetCommand extends Command {
    ...
    public void runCommand(ArrayList<String> args) {
        if (args.size() >= 2) {
            ...
            switch (subCommand) {
                case "add":
                    ...
                    String added = Miau.targetManager.add(args.get(2));
                    if (added == null) {
                ...
                case "remove":
                    ...
                    String removed = Miau.targetManager.remove(args.get(2));
                    if (removed == null) {
                    ...
                    return;
                case "list":
                    ArrayList<String> list = Miau.targetManager.getPlayers();
                    if (list.isEmpty()) {
        ...
        ChatUtil.display(
            String.format(
                "%sUsage: .%s <&oadd&r/&oremove&r/&olist&r/&oclear&r>&r", args.get(0).toLowerCase(Locale.ROOT)
            )
        );
    }
}
