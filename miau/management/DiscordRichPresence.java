...
public class DiscordRichPresence {
    ...
    private static final String CLIENT_ID = "1533393088788168754";
    private static final String DEFAULT_DETAILS = "Miau Minus Client";
    private static final String DEFAULT_STATE = "";
    private static final String LARGE_IMAGE = "logo";
    private static final String LARGE_IMAGE_TEXT = "Miau Minus Client";
        ...
        if (!this.running && rpc != null) {
            ...
            if (now >= this.nextStartAttempt) {
                ...
                try {
                    ...
                    this.lastUpdate = 0L;
                    this.write(0, "{\"v\":1,\"client_id\":\"" + escape("1533393088788168754") + "\"}");
    ...
    private String buildActivity(RPC rpc) {
        String details = rpc.showServer.getValue() ? this.getServerText() : "Miau Minus Client";
        String state = rpc.showModulesCount.getValue() ? this.getModulesText() : "";
        ...
        builder.append("\"large_image\":\"").append(escape("logo")).append("\"");
        builder.append(",\"large_text\":\"").append(escape("Miau Minus Client")).append("\"");
    ...
    private String getServerText() {
        ...
        return !mc.func_71387_A() && data != null ? "Server: " + data.field_78845_b : "Server: Singleplayer";
    }
    ...
    private String getSmallImageText() {
        return mc.field_71439_g != null
                && mc.field_71439_g.func_70005_c_() != null
                && !mc.field_71439_g.func_70005_c_().trim().isEmpty()
