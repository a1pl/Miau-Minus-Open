...
public class InvManager extends Module {
    ...
    public final IntProperty autoArmorInterval = new IntProperty(
        "auto-armor-interval", 0, 0, 100, this.autoArmor::getValue
    );
    ...
    private void clickSlot(int windowId, int slotId, int mouseButtonClicked, int mode) {
        mc.field_71442_b.func_78753_a(windowId, slotId, mouseButtonClicked, mode, mc.field_71439_g);
    }
    ...
    public void onUpdate(UpdateEvent event) {
        if (event.getType() == EventType.PRE) {
            ...
            if (!(mc.field_71462_r instanceof GuiInventory)) {
            ...
            } else if (!(((GuiInventory)mc.field_71462_r).field_147002_h instanceof ContainerPlayer)) {
                this.inventoryOpen = false;
            } else {
                ...
                if (this.oDelay <= 0 && this.actionDelay <= 0 && this.isEnabled() && this.isValidGameMode()) {
                    ...
                    int inventorySwordSlot = ItemUtil.findSwordInInventorySlot(
                        preferredSwordHotbarSlot, this.checkDurability.getValue()
                    );
                    ...
                    int inventoryPickaxeSlot = ItemUtil.findInventorySlot(
                        "pickaxe", preferredPickaxeHotbarSlot, this.checkDurability.getValue()
                    );
                    ...
                    int inventoryShovelSlot = ItemUtil.findInventorySlot(
                        "shovel", preferredShovelHotbarSlot, this.checkDurability.getValue()
                    );
                    ...
                    int inventoryAxeSlot = ItemUtil.findInventorySlot(
                        "axe", preferredAxeHotbarSlot, this.checkDurability.getValue()
                    );
                    ...
                    int inventoryBlocksSlot = ItemUtil.findInventorySlot(
                        preferredBlocksHotbarSlot, ItemUtil.ItemType.Block
                    );
                    int preferredProjectileHotbarSlot = this.projectileSlot.getValue() - 1;
                    int inventoryProjectileSlot = ItemUtil.findInventorySlot(
                        preferredProjectileHotbarSlot, ItemUtil.ItemType.Projectile
                    );
                    if (inventoryProjectileSlot == -1) {
                        inventoryProjectileSlot = ItemUtil.findInventorySlot(
                            preferredProjectileHotbarSlot, ItemUtil.ItemType.FishRod
                        );
                    }

                    int preferredGoldAppleHotbarSlot = this.goldAppleSlot.getValue() - 1;
                    int inventoryGoldAppleSlot = ItemUtil.findInventorySlot(
                        preferredGoldAppleHotbarSlot, ItemUtil.ItemType.GoldApple
                    );
                    int preferredBowHotbarSlot = this.bowSlot.getValue() - 1;
                    int inventoryBowSlot = ItemUtil.findBowInventorySlot(
                        preferredBowHotbarSlot, this.checkDurability.getValue()
                    );
                    ...
                    if (this.autoArmor.getValue()
                        && this.autoArmorTime.hasTimeElapsed(this.autoArmorInterval.getValue().intValue() * 50L)) {
                        for (int i = 0; i < 4; i++) {
                            ...
                            if (equippedSlot != -1 || inventorySlot != -1) {
                                ...
                                if (equippedSlot != playerArmorSlot && inventorySlot != playerArmorSlot) {
                                    if (mc.field_71439_g.field_71071_by.func_70301_a(playerArmorSlot) != null) {
                                        if (mc.field_71439_g.field_71071_by.func_70447_i() != -1) {
                                            this.clickSlot(
                                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                                this.convertSlotIndex(playerArmorSlot),
                                                0,
                                                1
                                            );
                                        } else {
                                        ...
                                        this.clickSlot(
                                            mc.field_71439_g.field_71069_bz.field_75152_c,
                                            this.convertSlotIndex(armorToEquipSlot),
                                            0,
                                            1
                                        );
                                        this.autoArmorTime.reset();
                    ...
                    if (preferredSwordHotbarSlot >= 0 && preferredSwordHotbarSlot <= 8 && inventorySwordSlot != -1) {
                        ...
                        if (inventorySwordSlot != preferredSwordHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventorySwordSlot),
                    ...
                    if (preferredPickaxeHotbarSlot >= 0
                        ...
                        if (inventoryPickaxeSlot != preferredPickaxeHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventoryPickaxeSlot),
                    ...
                    if (preferredShovelHotbarSlot >= 0
                        ...
                        if (inventoryShovelSlot != preferredShovelHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventoryShovelSlot),
                    ...
                    if (preferredAxeHotbarSlot >= 0
                        ...
                        if (inventoryAxeSlot != preferredAxeHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventoryAxeSlot),
                    ...
                    if (preferredBlocksHotbarSlot >= 0
                        ...
                        if (inventoryBlocksSlot != preferredBlocksHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventoryBlocksSlot),
                    ...
                    if (preferredProjectileHotbarSlot >= 0
                        ...
                        && !usedHotbarSlots.contains(preferredProjectileHotbarSlot)
                        ...
                        if (inventoryProjectileSlot != preferredProjectileHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventoryProjectileSlot),
                    ...
                    if (preferredGoldAppleHotbarSlot >= 0
                        ...
                        && !usedHotbarSlots.contains(preferredGoldAppleHotbarSlot)
                        ...
                        if (inventoryGoldAppleSlot != preferredGoldAppleHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventoryGoldAppleSlot),
                    ...
                    if (preferredBowHotbarSlot >= 0
                        ...
                        && !usedHotbarSlots.contains(preferredBowHotbarSlot)
                        && inventoryBowSlot != -1) {
                        usedHotbarSlots.add(preferredBowHotbarSlot);
                        if (inventoryBowSlot != preferredBowHotbarSlot) {
                            this.clickSlot(
                                mc.field_71439_g.field_71069_bz.field_75152_c,
                                this.convertSlotIndex(inventoryBowSlot),
                        ...
                        for (int i = 0; i < 36; i++) {
                            if (!equippedArmorSlots.contains(i)
                                ...
                                if (stack != null) {
                                    ...
                                    if (isBlock
                                        ? currentBlockCount > this.blocks.getValue()
                                        : (
                                            isProjectile
                                                ? currentProjectileCount > this.projectiles.getValue()
