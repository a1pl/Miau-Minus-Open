...
public class LagRange2 extends Module {
    ...
    public final BooleanProperty sprintReset = new BooleanProperty(
        "sprint-reset", true, () -> this.aggressive.getValue()
    );
    public final BooleanProperty blockSword = new BooleanProperty("block-sword", true, () -> this.aggressive.getValue());
    public final BooleanProperty splashPotion = new BooleanProperty(
        "splash-potion", true, () -> this.aggressive.getValue()
    );
    public final BooleanProperty realPosIndicator = new BooleanProperty(
        "real-pos-indicator", true, () -> this.aggressive.getValue()
    );
    public final BooleanProperty showFirstPerson = new BooleanProperty(
        "show-first-person", false, () -> this.aggressive.getValue() && this.realPosIndicator.getValue()
    );
    public final FloatProperty indicatorLineWidth = new FloatProperty(
        "indicator-line-width", 2.0F, 0.5F, 5.0F, () -> this.aggressive.getValue() && this.realPosIndicator.getValue()
    );
    public final BooleanProperty indicatorFilled = new BooleanProperty(
        "indicator-filled", true, () -> this.aggressive.getValue() && this.realPosIndicator.getValue()
    );
                ...
                if (players.isEmpty()) {
                    ...
                    if (nextTarget != null && !(closestDist > rangeSq)) {
                        ...
                        if (this.isLagging) {
                            ...
                            boolean hitStart = hitMarkedHere && dist <= 3.0 && selfHurtTime == 0 && moving && weaponOk;
                            this.lastDistSq = dist;
    ...
    public void onRender3D(Render3DEvent event) {
        if (this.isEnabled() && this.hasTarget && this.lastPosition != null && this.currentPosition != null) {
            if (this.showPosition.getValue() != 0 && mc.field_71474_y.field_74320_O != 0) {
            ...
            if (this.aggressive.getValue()
                ...
                && (mc.field_71474_y.field_74320_O != 0 || this.showFirstPerson.getValue())) {
                Color color = Themes.getCurrentTheme().getFirstColor();
                ...
                GL11.glLineWidth(this.indicatorLineWidth.getValue());
                if (this.indicatorFilled.getValue()) {
