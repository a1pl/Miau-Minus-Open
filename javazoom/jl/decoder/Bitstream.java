...
public final class Bitstream implements BitstreamErrors {
    ...
    public boolean isSyncCurrentPosition(int syncmode) throws BitstreamException {
        ...
        int headerstring = this.syncbuf[0] << 24 & 0xFF000000
            | this.syncbuf[1] << 16 & 0xFF0000
            | this.syncbuf[2] << 8 & 0xFF00
            | this.syncbuf[3] << 0 & 0xFF;
    ...
    int syncHeader(byte syncmode) throws BitstreamException {
        ...
        int headerstring = this.syncbuf[0] << 16 & 0xFF0000
            | this.syncbuf[1] << 8 & 0xFF00
            | this.syncbuf[2] << 0 & 0xFF;
