...
class LayerIIDecoder extends LayerIDecoder implements FrameDecoder {
    ...
    static class SubbandLayer2 extends LayerIDecoder.Subband {
        ...
        public static final int[] table_ab1_codelength = new int[]{
        ...
        public static final int[] table_ab2_codelength = new int[]{
        ...
        public static final float[] table_ab3_factor = new float[]{
            0.0F, 0.5F, 0.25F, 0.25F, 0.125F, 0.125F, 0.0625F, 3.0517578E-5F
        };
        public static final float[] table_ab3_c = new float[]{
            0.0F, 1.3333334F, 1.6F, 1.1428572F, 1.7777778F, 1.0666667F, 1.032258F, 1.0000153F
        };
        public static final float[] table_ab3_d = new float[]{
            0.0F, 0.5F, 0.5F, 0.25F, 0.5F, 0.125F, 0.0625F, 3.051758E-5F
        };
        ...
        public static final int[] table_cd_codelength = new int[]{
        ...
        protected void prepare_sample_reading(
            ...
            if (this.allocation != 0) {
                ...
                switch (this.channel2_scfsi) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        this.channel2_scalefactor1 = this.channel2_scalefactor2 = this.channel2_scalefactor3 = scalefactors[stream.get_bits(
                            6
                        )];
                        break;
                    case 3:
        ...
        public boolean read_sampledata(Bitstream stream) {
            ...
            if (this.channel2_allocation != 0) {
                if (this.groupingtable[1] != null) {
                    ...
                    this.channel2_samples[0] = (float)(
                        stream.get_bits(this.channel2_codelength[0]) * this.channel2_factor[0] - 1.0
                    );
                    this.channel2_samples[1] = (float)(
                        stream.get_bits(this.channel2_codelength[0]) * this.channel2_factor[0] - 1.0
                    );
                    this.channel2_samples[2] = (float)(
                        stream.get_bits(this.channel2_codelength[0]) * this.channel2_factor[0] - 1.0
                    );
                }
            }
