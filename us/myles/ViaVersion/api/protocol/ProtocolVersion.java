...
public class ProtocolVersion {
    ...
    public static ProtocolVersion register(
        int version, int snapshotVersion, String name, @Nullable SubVersionRange versionRange
    ) {
    ...
    public ProtocolVersion(int version, int snapshotVersion, String name, @Nullable SubVersionRange versionRange) {
        ...
        Preconditions.checkArgument(
            !this.versionWildcard || versionRange == null,
            "A version cannot be a wildcard and a range at the same time!"
        );
