...
public class TranslatableRewriter<C extends ClientboundPacketType> extends ComponentRewriter<C> {
    ...
    public static void loadTranslatables() {
        JsonObject jsonObject = BackwardsMappingDataLoader.INSTANCE.loadFromDataDir("translation-mappings.json");
    ...
    public TranslatableRewriter(
        BackwardsProtocol<C, ?, ?, ?> protocol, ComponentRewriter.ReadType type, String sectionIdentifier
    ) {
        super(protocol, type);
