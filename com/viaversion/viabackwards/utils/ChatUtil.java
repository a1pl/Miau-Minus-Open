...
public final class ChatUtil {
    ...
    private static final Pattern UNUSED_COLOR_PATTERN_PREFIX = Pattern.compile(
        "(?>(?>§[0-fk-or])*(§r))|(?>(?>§[0-f])*(§[0-f]))"
    );
    ...
    private static class ChatFormattingState {
        ...
        public boolean equals(Object o) {
            if (this == o) {
                ...
                return this.defaultColor == that.defaultColor
                    && this.color == that.color
                    && Objects.equals(this.formatting, that.formatting);
            } else {
                return false;
            }
        }
