...
public final class EntityPackets1_20 extends EntityRewriter<ClientboundPackets1_19_4, Protocol1_19_4To1_20> {
    ...
    public void registerPackets() {
        ...
        this.registerMetadataRewriter(
            ClientboundPackets1_19_4.ENTITY_METADATA, Types1_20.METADATA_LIST, Types1_19_4.METADATA_LIST
        );
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                if (trimPatternTag == null
                                    && (trimPatternTag = registry.getCompoundTag("trim_pattern")) == null) {
                                    CompoundTag trimPatternRegistry = Protocol1_19_4To1_20.MAPPINGS
                                ...
                                for (CompoundTag entry : values) {
                                    ...
                                    if (EntityPackets1_20.this.newTrimPatterns
                                        .contains(Key.stripMinecraftNamespace(templateItem.getValue()))) {
