...
public final class BlockItemPacketRewriter1_20_2
    extends BackwardsItemRewriter<ClientboundPackets1_20_2, ServerboundPackets1_19_4, Protocol1_20To1_20_2> {
    ...
    public void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_20_2.WINDOW_ITEMS,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                wrapper.write(
                                    Type.ITEM1_13_2,
                                    BlockItemPacketRewriter1_20_2.this.handleItemToClient(
                                        wrapper.user(), wrapper.read(Type.ITEM1_20_2)
                                    )
                                );
                            }
                        );
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_20_2.SET_SLOT,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.UNSIGNED_BYTE);
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_20_2.ADVANCEMENTS,
                wrapper -> {
                    wrapper.passthrough(Type.BOOLEAN);
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (wrapper.passthrough(Type.BOOLEAN)) {
                            ...
                            wrapper.passthrough(Type.COMPONENT);
                            wrapper.write(
                                Type.ITEM1_13_2, this.handleItemToClient(wrapper.user(), wrapper.read(Type.ITEM1_20_2))
                            );
                            wrapper.passthrough(Type.VAR_INT);
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_20_2.ENTITY_EQUIPMENT,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
        ...
        this.protocol
            .registerServerbound(
                ServerboundPackets1_19_4.CLICK_WINDOW,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.UNSIGNED_BYTE);
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                for (int i = 0; i < length; i++) {
                                    ...
                                    wrapper.write(
                                        Type.ITEM1_20_2,
                                        BlockItemPacketRewriter1_20_2.this.handleItemToServer(
        ...
        this.protocol.registerClientbound(ClientboundPackets1_20_2.TRADE_LIST, wrapper -> {
            ...
            for (int i = 0; i < size; i++) {
                wrapper.write(Type.ITEM1_13_2, this.handleItemToClient(wrapper.user(), wrapper.read(Type.ITEM1_20_2)));
                wrapper.write(Type.ITEM1_13_2, this.handleItemToClient(wrapper.user(), wrapper.read(Type.ITEM1_20_2)));
                wrapper.write(Type.ITEM1_13_2, this.handleItemToClient(wrapper.user(), wrapper.read(Type.ITEM1_20_2)));
                wrapper.passthrough(Type.BOOLEAN);
        ...
        this.protocol
            .registerServerbound(
                ServerboundPackets1_19_4.CREATIVE_INVENTORY_ACTION,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.SHORT);
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_20_2.SPAWN_PARTICLE,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                if (mappings.isBlockParticle(id)) {
                                    ...
                                    wrapper.write(
                                        Type.VAR_INT,
                                        BlockItemPacketRewriter1_20_2.this.protocol
                                            .getMappingData()
    ...
    public @Nullable Item handleItemToClient(UserConnection connection, @Nullable Item item) {
        ...
        if (item.tag() != null) {
            com.viaversion.viaversion.protocols.protocol1_20_2to1_20.rewriter.BlockItemPacketRewriter1_20_2.to1_20_1Effects(
                item
            );
        }
    ...
    public @Nullable Item handleItemToServer(UserConnection connection, @Nullable Item item) {
        ...
        if (item.tag() != null) {
            com.viaversion.viaversion.protocols.protocol1_20_2to1_20.rewriter.BlockItemPacketRewriter1_20_2.to1_20_2Effects(
                item
            );
        }
