...
public final class EntityPacketRewriter1_20_2 extends EntityRewriter<ClientboundPackets1_20_2, Protocol1_20To1_20_2> {
    ...
    public void registerPackets() {
        this.registerMetadataRewriter(
            ClientboundPackets1_20_2.ENTITY_METADATA, Types1_20_2.METADATA_LIST, Types1_20.METADATA_LIST
        );
                            ...
                            wrapper -> {
                                ...
                                if (entityType != EntityTypes1_19_4.PLAYER.getId()) {
                                    ...
                                    if (entityType == EntityTypes1_19_4.FALLING_BLOCK.getId()) {
                                        ...
                                        wrapper.write(
                                            Type.VAR_INT,
                                            EntityPacketRewriter1_20_2.this.protocol
                                                .getMappingData()
                                    ...
                                    if (velocityX != 0 || velocityY != 0 || velocityZ != 0) {
                                        ...
                                        wrapper.cancel();
                                        PacketWrapper velocityPacket = wrapper.create(
                                            ClientboundPackets1_19_4.ENTITY_VELOCITY
                                        );
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_20_2.JOIN_GAME,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.handler(
                            wrapper -> {
                                ConfigurationPacketStorage configurationPacketStorage = wrapper.user()
                                    .remove(ConfigurationPacketStorage.class);
                                ...
                                if (configurationPacketStorage.enabledFeatures() != null) {
                                    PacketWrapper featuresPacket = wrapper.create(
                                        ClientboundPackets1_19_4.UPDATE_ENABLED_FEATURES
                                    );
                                    featuresPacket.write(
                                        Type.STRING_ARRAY, configurationPacketStorage.enabledFeatures()
                                    );
