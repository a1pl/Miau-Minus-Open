    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(
            ...
            wrapper -> {
                ...
                wrapper.create(ServerboundLoginPackets.LOGIN_ACKNOWLEDGED)
                    .scheduleSendToServer(Protocol1_20To1_20_2.class);
            }
        );
        this.registerClientbound(
            State.CONFIGURATION,
            ...
            wrapper -> {
                ...
                wrapper.create(ServerboundConfigurationPackets1_20_2.FINISH_CONFIGURATION)
                    .sendToServer(Protocol1_20To1_20_2.class);
        ...
        this.registerClientbound(
            ClientboundPackets1_20_2.START_CONFIGURATION,
            null,
            wrapper -> {
                wrapper.cancel();
                wrapper.user().getProtocolInfo().setServerState(State.CONFIGURATION);
                PacketWrapper configAcknowledgedPacket = wrapper.create(
                    ServerboundPackets1_20_2.CONFIGURATION_ACKNOWLEDGED
                );
        ...
        this.registerClientbound(
            State.CONFIGURATION,
            ClientboundConfigurationPackets1_20_2.PING.getId(),
            -1,
            wrapper -> wrapper.setPacketType(ClientboundPackets1_19_4.PING)
        );
        this.registerClientbound(
            State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.RESOURCE_PACK.getId(), -1, wrapper -> {
        ...
        this.registerClientbound(
            State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.REGISTRY_DATA.getId(), -1, wrapper -> {
                wrapper.cancel();
        ...
        this.registerClientbound(
            State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.UPDATE_TAGS.getId(), -1, wrapper -> {
                this.tagRewriter.getGenericHandler().handle(wrapper);
                wrapper.user()
                    .get(ConfigurationPacketStorage.class)
                    .addRawPacket(wrapper, ClientboundPackets1_19_4.TAGS);
                wrapper.cancel();
            }
        );
        this.registerClientbound(
            State.CONFIGURATION,
            ClientboundConfigurationPackets1_20_2.CUSTOM_PAYLOAD.getId(),
            -1,
            wrapper -> {
                wrapper.user()
                    .get(ConfigurationPacketStorage.class)
                    .addRawPacket(wrapper, ClientboundPackets1_19_4.PLUGIN_MESSAGE);
                wrapper.cancel();
            }
        );
    }
