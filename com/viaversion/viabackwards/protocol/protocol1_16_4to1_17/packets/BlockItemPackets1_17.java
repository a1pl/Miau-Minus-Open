...
public final class BlockItemPackets1_17
    extends BackwardsItemRewriter<ClientboundPackets1_17, ServerboundPackets1_16_2, Protocol1_16_4To1_17> {
    ...
    protected void registerPackets() {
                    ...
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                Item clicked = BlockItemPackets1_17.this.handleItemToServer(
                                    wrapper.user(), wrapper.read(Type.ITEM1_13_2)
                                );
        ...
        this.protocol.registerClientbound(ClientboundPackets1_17.SET_SLOT, wrapper -> {
            ...
            wrapper.write(Type.ITEM1_13_2, this.handleItemToClient(wrapper.user(), carried));
        });
        ...
        this.protocol
            .mergePacket(ClientboundPackets1_17.WORLD_BORDER_LERP_SIZE, ClientboundPackets1_16_2.WORLD_BORDER, 1);
        ...
        this.protocol
            .mergePacket(ClientboundPackets1_17.WORLD_BORDER_WARNING_DELAY, ClientboundPackets1_16_2.WORLD_BORDER, 4);
        this.protocol
            .mergePacket(ClientboundPackets1_17.WORLD_BORDER_WARNING_DISTANCE, ClientboundPackets1_16_2.WORLD_BORDER, 5);
        this.protocol
            .registerClientbound(
                ClientboundPackets1_17.UPDATE_LIGHT,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                int cutSkyLightMask = BlockItemPackets1_17.this.cutLightMask(
                                    skyLightMask, startFromSection
                                );
                                int cutBlockLightMask = BlockItemPackets1_17.this.cutLightMask(
                                    blockLightMask, startFromSection
                                );
                                ...
                                wrapper.write(
                                    Type.VAR_INT,
                                    BlockItemPackets1_17.this.cutLightMask(emptySkyLightMask, startFromSection)
                                );
                                wrapper.write(
                                    Type.VAR_INT,
                                    BlockItemPackets1_17.this.cutLightMask(emptyBlockLightMask, startFromSection)
                                );
                                this.writeLightArrays(
                                    wrapper,
                    ...
                    private void writeLightArrays(
                        PacketWrapper wrapper, BitSet bitMask, int cutBitMask, int startFromSection, int sectionHeight
                    ) throws Exception {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_17.MULTI_BLOCK_CHANGE,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.LONG);
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                if (chunkY >= 0 && chunkY <= 15) {
                                    BlockChangeRecord[] records = wrapper.passthrough(
                                        Type.VAR_LONG_BLOCK_CHANGE_RECORD_ARRAY
                                    );

                                    for (BlockChangeRecord record : records) {
                                        record.setBlockId(
                                            BlockItemPackets1_17.this.protocol
                                                .getMappingData()
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_17.BLOCK_CHANGE,
                new PacketHandlers() {
                    @Override
                    public void register() {
                            ...
                            wrapper -> {
                                ...
                                if (y >= 0 && y <= 255) {
                                    wrapper.set(
                                        ...
                                        BlockItemPackets1_17.this.protocol
                                            .getMappingData()
                                            .getNewBlockStateId(wrapper.get(Type.VAR_INT, 0))
                                    );
                                } else {
                                    wrapper.cancel();
                                }
        ...
        this.protocol
            .registerClientbound(
                ...
                wrapper -> {
                    ...
                    int startFromSection = Math.max(0, -(tracker.currentMinY() >> 4));
                    chunk.setBiomeData(
                        Arrays.copyOfRange(chunk.getBiomeData(), startFromSection * 64, startFromSection * 64 + 1024)
                    );
                    chunk.setBitmask(this.cutMask(chunk.getChunkMask(), startFromSection, false));
                    chunk.setChunkMask(null);
                    ChunkSection[] sections = Arrays.copyOfRange(
                        chunk.getSections(), startFromSection, startFromSection + 16
                    );
                    ...
                    for (Tag heightMapTag : heightMaps.values()) {
                        ...
                        CompactArrayUtil.iterateCompactArrayWithPadding(
                            ...
                            heightMap.getValue(),
                            (i, v) -> heightMapData[i] = MathUtil.clamp(v + tracker.currentMinY(), 0, 255)
                        );
                        heightMap.setValue(
