...
public final class BlockItemPackets1_19
    extends BackwardsItemRewriter<ClientboundPackets1_19, ServerboundPackets1_17, Protocol1_18_2To1_19> {
    ...
    protected void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19.TRADE_LIST,
                new PacketHandlers() {
                    @Override
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                for (int i = 0; i < size; i++) {
                                    BlockItemPackets1_19.this.handleItemToClient(
                                    ...
                                    if (secondItem != null) {
                                        BlockItemPackets1_19.this.handleItemToClient(wrapper.user(), secondItem);
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19.SPAWN_PARTICLE,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                ParticleMappings particleMappings = BlockItemPackets1_19.this.protocol
                                    .getMappingData()
                                    .getParticleMappings();
