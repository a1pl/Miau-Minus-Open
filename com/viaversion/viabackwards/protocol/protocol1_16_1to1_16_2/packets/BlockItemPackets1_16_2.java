...
public class BlockItemPackets1_16_2
    extends BackwardsItemRewriter<ClientboundPackets1_16_2, ServerboundPackets1_16, Protocol1_16_1To1_16_2> {
    ...
    protected void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_16_2.CHUNK_DATA,
                wrapper -> {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_16_2.BLOCK_ENTITY_DATA,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> BlockItemPackets1_16_2.this.handleBlockEntity(
                                wrapper.passthrough(Type.NAMED_COMPOUND_TAG)
                            )
                        );
                    }
                }
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_16_2.MULTI_BLOCK_CHANGE,
                wrapper -> {
                    ...
                    for (int i = 0; i < blockChangeRecord.length; i++) {
                        ...
                        blockChangeRecord[i] = new BlockChangeRecord1_8(
                            record.getSectionX(), record.getY(chunkY), record.getSectionZ(), blockId
                        );
                    }
                }
            );
