...
public class EntityPackets1_16_2 extends EntityRewriter<ClientboundPackets1_16_2, Protocol1_16_1To1_16_2> {
    private final Set<String> oldDimensions = Sets.newHashSet(
    ...
    protected void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_16_2.JOIN_GAME,
                new PacketHandlers() {
                    @Override
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                if (wrapper.user()
                                    .getProtocolInfo()
                                    .protocolVersion()
                                    .olderThanOrEqualTo(ProtocolVersion.v1_15_2)) {
                                    ...
                                    ViaBackwards.getPlatform()
                                        .getLogger()
                                        .warning(
                                            "1.16 and 1.16.1 clients are only partially supported and may have wrong biomes displayed."
                                        );
                                }
    ...
    private String getDimensionFromData(CompoundTag dimensionData) {
        ...
        return effectsLocation != null && this.oldDimensions.contains(Key.namespaced(effectsLocation.getValue()))
            ? effectsLocation.getValue()
            : "minecraft:overworld";
    }
