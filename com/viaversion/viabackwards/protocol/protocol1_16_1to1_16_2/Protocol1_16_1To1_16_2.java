...
public class Protocol1_16_1To1_16_2
    ...
    public static final BackwardsMappings MAPPINGS = new BackwardsMappings(
        "1.16.2", "1.16", Protocol1_16_2To1_16_1.class
    );
    ...
    private final TranslatableRewriter<ClientboundPackets1_16_2> translatableRewriter = new TranslatableRewriter<>(
    ...
    protected void registerPackets() {
        ...
        this.tagRewriter.register(ClientboundPackets1_16_2.TAGS, RegistryType.ENTITY);
    ...
    public void init(UserConnection user) {
        ...
        user.addEntityTracker(
            (Class<? extends Protocol>)this.getClass(), new EntityTrackerBase(user, EntityTypes1_16_2.PLAYER)
        );
    }
