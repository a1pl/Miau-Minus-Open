...
public class Protocol1_13To1_13_1
    ...
    private final TranslatableRewriter<ClientboundPackets1_13> translatableRewriter = new TranslatableRewriter<>(
    ...
    protected void registerPackets() {
        ...
        this.registerServerbound(
            ...
            new PacketHandlers() {
                ...
                public void register() {
                    ...
                    this.handler(
                        wrapper -> {
                            Protocol1_13To1_13_1.this.itemRewriter
                                .handleItemToServer(wrapper.user(), wrapper.get(Type.ITEM1_13, 0));
        ...
        this.registerClientbound(
            ClientboundPackets1_13.OPEN_WINDOW,
            new PacketHandlers() {
                @Override
                public void register() {
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            Protocol1_13To1_13_1.this.translatableRewriter.processText(wrapper.user(), title);
                            if (ViaBackwards.getConfig().fix1_13FormattedInventoryTitle()) {
                                if (title.isJsonObject()
                                    && title.getAsJsonObject().size() == 1
        ...
        this.registerClientbound(
            ClientboundPackets1_13.BOSSBAR,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.UUID);
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            if (action == 0 || action == 3) {
                                Protocol1_13To1_13_1.this.translatableRewriter
        ...
        this.tagRewriter.register(ClientboundPackets1_13.TAGS, RegistryType.ITEM);
        new StatisticsRewriter<>(this).register(ClientboundPackets1_13.STATISTICS);
    }

    @Override
    public void init(UserConnection user) {
        user.addEntityTracker(
            (Class<? extends Protocol>)this.getClass(), new EntityTrackerBase(user, EntityTypes1_13.EntityType.PLAYER)
        );
