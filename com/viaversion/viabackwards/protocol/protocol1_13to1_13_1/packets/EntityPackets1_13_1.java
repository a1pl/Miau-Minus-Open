                            ...
                            wrapper -> {
                                ...
                                if (entType == null) {
                                    ViaBackwards.getPlatform()
                                        .getLogger()
                                        .warning("Could not find 1.13 entity type " + type);
                                } else {
                                    if (entType.is(EntityTypes1_13.EntityType.FALLING_BLOCK)) {
                                        ...
                                        wrapper.set(
                                            Type.INT,
                                            0,
                                            EntityPackets1_13_1.this.protocol.getMappingData().getNewBlockStateId(data)
                                        );
                                    }

                                    EntityPackets1_13_1.this.<EntityTracker>tracker(wrapper.user())
                                        .addEntity(entityId, entType);
                                }
                            }
                        );
                    }
            ...
            .registerClientbound(
                ...
                new PacketHandlers() {
                    ...
                    public void register() {
                        ...
                        this.map(Types1_13.METADATA_LIST);
                        this.handler(
                            EntityPackets1_13_1.this.getTrackerAndMetaHandler(
                                Types1_13.METADATA_LIST, EntityTypes1_13.EntityType.PLAYER
                            )
                        );
                    }
                }
            ...
            .handler(
                (event, meta) -> {
                    if (meta.metaType() == Types1_13.META_TYPES.itemType) {
                        this.protocol.getItemRewriter().handleItemToClient(event.user(), (Item)meta.getValue());
                        ...
                        || meta.metaType() == Types1_13.META_TYPES.componentType) {
