...
public class EntityPackets1_11 extends LegacyEntityRewriter<ClientboundPackets1_9_3, Protocol1_10To1_11> {
    ...
    protected void registerPackets() {
            ...
            .registerClientbound(
                ...
                new PacketHandlers() {
                    ...
                    public void register() {
                        ...
                        this.handler(
                            EntityPackets1_11.this.getObjectRewriter(
                                id -> EntityTypes1_11.ObjectType.findById(id).orElse(null)
                            )
                        );
                        this.handler(EntityPackets1_11.this.protocol.getItemRewriter().getFallingBlockHandler());
                    }
                }
            );
        ...
        this.protocol.registerClientbound(ClientboundPackets1_9_3.SPAWN_MOB, new PacketHandlers() {
            ...
            public void register() {
                ...
                this.handler(EntityPackets1_11.this.getMobSpawnRewriter(Types1_9.METADATA_LIST));
                this.handler(wrapper -> {
            ...
            .registerClientbound(
                ...
                new PacketHandlers() {
                    ...
                    public void register() {
                        ...
                        this.map(Types1_9.METADATA_LIST);
                        this.handler(
                            EntityPackets1_11.this.getTrackerAndMetaHandler(
    ...
    protected void registerRewrites() {
        ...
        this.mapEntityTypeWithData(EntityTypes1_11.EntityType.EVOCATION_ILLAGER, EntityTypes1_11.EntityType.VILLAGER)
            .plainName();
