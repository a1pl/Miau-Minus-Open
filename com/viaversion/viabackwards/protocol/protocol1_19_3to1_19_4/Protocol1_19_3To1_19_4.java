...
public final class Protocol1_19_3To1_19_4
    ...
    public static final BackwardsMappings MAPPINGS = new BackwardsMappings(
        "1.19.4", "1.19.3", Protocol1_19_4To1_19_3.class
    );
    ...
    private final TranslatableRewriter<ClientboundPackets1_19_4> translatableRewriter = new TranslatableRewriter<>(
    ...
    protected void registerPackets() {
                ...
                public void handleArgument(PacketWrapper wrapper, String argumentType) throws Exception {
                    switch (argumentType) {
                        ...
                        case "minecraft:resource_or_tag":
                            ...
                            wrapper.write(
                                Type.STRING,
                                resource.equals("minecraft:damage_type") ? "minecraft:mob_effect" : resource
                            );
                            break;
                        default:
        ...
        this.tagRewriter.registerGeneric(ClientboundPackets1_19_4.TAGS);
        new StatisticsRewriter<>(this).register(ClientboundPackets1_19_4.STATISTICS);
        this.registerClientbound(
            ClientboundPackets1_19_4.SERVER_DATA,
            wrapper -> {
                ...
                String iconBase64 = iconBytes != null
                    ? "data:image/png;base64,"
                        + new String(Base64.getEncoder().encode(iconBytes), StandardCharsets.UTF_8)
                    : null;
