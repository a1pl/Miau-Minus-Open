...
public final class BlockItemPackets1_19_4
    extends BackwardsItemRewriter<ClientboundPackets1_19_4, ServerboundPackets1_19_3, Protocol1_19_3To1_19_4> {
    ...
    public void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_4.OPEN_WINDOW,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                BlockItemPackets1_19_4.this.protocol
        ...
        RecipeRewriter1_19_3<ClientboundPackets1_19_4> recipeRewriter = new RecipeRewriter1_19_3<ClientboundPackets1_19_4>(
            this.protocol
        ) {
            @Override
            public void handleCraftingShaped(PacketWrapper wrapper) throws Exception {
                ...
                this.rewrite(wrapper.user(), wrapper.passthrough(Type.ITEM1_13_2));
