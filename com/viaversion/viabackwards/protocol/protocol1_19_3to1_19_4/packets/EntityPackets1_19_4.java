...
public final class EntityPackets1_19_4 extends EntityRewriter<ClientboundPackets1_19_4, Protocol1_19_3To1_19_4> {
    ...
    public void registerPackets() {
        ...
        this.registerMetadataRewriter(
            ClientboundPackets1_19_4.ENTITY_METADATA, Types1_19_4.METADATA_LIST, Types1_19_3.METADATA_LIST
        );
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_4.DAMAGE_EVENT, ClientboundPackets1_19_3.ENTITY_STATUS, new PacketHandlers() {
                    @Override
                    public void register() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_4.HIT_ANIMATION,
                ClientboundPackets1_19_3.ENTITY_ANIMATION,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
    ...
    public void registerRewrites() {
        ...
        this.filter().type(EntityTypes1_19_4.TEXT_DISPLAY).index(22).handler((event, meta) -> {
            ...
            this.protocol.getTranslatableRewriter().processText(event.user(), element);
        });
    ...
    public void onMappingDataLoaded() {
        ...
        this.mapEntityTypeWithData(EntityTypes1_19_4.TEXT_DISPLAY, EntityTypes1_19_4.ARMOR_STAND)
            .spawnMetadata(displayMetaCreator);
        this.mapEntityTypeWithData(EntityTypes1_19_4.ITEM_DISPLAY, EntityTypes1_19_4.ARMOR_STAND)
            .spawnMetadata(displayMetaCreator);
        this.mapEntityTypeWithData(EntityTypes1_19_4.BLOCK_DISPLAY, EntityTypes1_19_4.ARMOR_STAND)
            .spawnMetadata(displayMetaCreator);
        this.mapEntityTypeWithData(EntityTypes1_19_4.INTERACTION, EntityTypes1_19_4.ARMOR_STAND)
            .spawnMetadata(displayMetaCreator);
