...
public class EntityPackets1_10 extends LegacyEntityRewriter<ClientboundPackets1_9_3, Protocol1_9_4To1_10> {
    ...
    protected void registerPackets() {
        this.protocol
            .registerClientbound(
                ClientboundPackets1_9_3.SPAWN_ENTITY,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            EntityPackets1_10.this.getObjectRewriter(
                                id -> EntityTypes1_11.ObjectType.findById(id).orElse(null)
                            )
                        );
                        this.handler(EntityPackets1_10.this.protocol.getItemRewriter().getFallingBlockHandler());
                    }
                }
            );
                    ...
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                EntityType type = EntityPackets1_10.this.<EntityTracker>tracker(wrapper.user())
                                    .entityType(entityId);
                                List<Metadata> metadata = wrapper.get(Types1_9.METADATA_LIST, 0);
                                EntityPackets1_10.this.handleMetadata(
                                    wrapper.get(Type.VAR_INT, 0), metadata, wrapper.user()
                                );
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_9_3.SPAWN_PLAYER,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.map(Types1_9.METADATA_LIST);
                        this.handler(
                            EntityPackets1_10.this.getTrackerAndMetaHandler(
                                Types1_9.METADATA_LIST, EntityTypes1_11.EntityType.PLAYER
                            )
                        );
                    }
                }
