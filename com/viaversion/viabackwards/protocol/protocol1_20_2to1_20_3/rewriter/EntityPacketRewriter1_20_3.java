...
public final class EntityPacketRewriter1_20_3 extends EntityRewriter<ClientboundPacket1_20_3, Protocol1_20_2To1_20_3> {
    ...
    public void registerPackets() {
        ...
        this.registerMetadataRewriter(
            ClientboundPackets1_20_3.ENTITY_METADATA, Types1_20_3.METADATA_LIST, Types1_20_2.METADATA_LIST
        );
        this.registerRemoveEntities(ClientboundPackets1_20_3.REMOVE_ENTITIES);
        this.protocol.registerClientbound(ClientboundConfigurationPackets1_20_3.REGISTRY_DATA, new PacketHandlers() {
            @Override
                ...
                (event, meta) -> {
                    ...
                    if (type == Types1_20_3.META_TYPES.componentType) {
                        meta.setTypeAndValue(
                            Types1_20_2.META_TYPES.componentType, ComponentUtil.tagToJson(meta.value())
                        );
                    } else if (type == Types1_20_3.META_TYPES.optionalComponentType) {
                        meta.setTypeAndValue(
                            Types1_20_2.META_TYPES.optionalComponentType, ComponentUtil.tagToJson(meta.value())
                        );
                    } else {
