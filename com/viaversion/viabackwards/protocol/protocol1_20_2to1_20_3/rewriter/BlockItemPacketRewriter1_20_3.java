...
public final class BlockItemPacketRewriter1_20_3
    extends BackwardsItemRewriter<ClientboundPacket1_20_3, ServerboundPacket1_20_2, Protocol1_20_2To1_20_3> {
                                ...
                                if (id == particleMappings.id("vibration")) {
                                    ...
                                    if (positionSourceType == 0) {
                                        ...
                                        ViaBackwards.getPlatform()
                                            .getLogger()
                                            .warning("Unknown position source type: " + positionSourceType);
                                        wrapper.cancel();
                                    }
                                }
                            }
