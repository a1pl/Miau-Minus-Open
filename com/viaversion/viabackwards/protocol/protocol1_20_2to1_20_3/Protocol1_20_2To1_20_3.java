...
public final class Protocol1_20_2To1_20_3
    ...
    public static final BackwardsMappings MAPPINGS = new BackwardsMappings(
        "1.20.3", "1.20.2", Protocol1_20_3To1_20_2.class
    );
    ...
    private final TranslatableRewriter<ClientboundPacket1_20_3> translatableRewriter = new TranslatableRewriter<>(
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(
            ClientboundPackets1_20_3.RESET_SCORE, ClientboundPackets1_20_2.UPDATE_SCORE, wrapper -> {
        ...
        this.registerClientbound(
            ClientboundPackets1_20_3.GAME_EVENT,
            wrapper -> {
                short reason = wrapper.passthrough(Type.UNSIGNED_BYTE);
                if (reason == 13) {
                    wrapper.cancel();
                    Pair<Position, Float> spawnPositionAndAngle = wrapper.user()
                        .get(SpawnPositionStorage.class)
                        .getSpawnPosition();
        ...
        this.registerClientbound(
            ClientboundConfigurationPackets1_20_3.UPDATE_TAGS, this.tagRewriter.getGenericHandler()
        );
    }
