...
public class EntityPackets1_14 extends LegacyEntityRewriter<ClientboundPackets1_14, Protocol1_13_2To1_14> {
    ...
    protected void registerPackets() {
        this.positionHandler = new EntityPositionHandler(
            this, EntityPositionStorage1_14.class, EntityPositionStorage1_14::new
        );
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_14.ENTITY_TELEPORT,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.map(Type.DOUBLE);
                        this.handler(
                            wrapper -> EntityPackets1_14.this.positionHandler
                                .cacheEntityPosition(wrapper, false, false)
                        );
                    }
                }
            );
        PacketHandlers relativeMoveHandler = new PacketHandlers() {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    double x = wrapper.get(Type.SHORT, 0).shortValue() / 4096.0;
                    double y = wrapper.get(Type.SHORT, 1).shortValue() / 4096.0;
                    double z = wrapper.get(Type.SHORT, 2).shortValue() / 4096.0;
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_14.SPAWN_ENTITY,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                            ...
                            wrapper -> {
                                ...
                                if (objectType != null) {
                                    ...
                                    if (objectType == EntityTypes1_13.ObjectType.FALLING_BLOCK) {
                                        ...
                                        int combined = EntityPackets1_14.this.protocol
                                            .getMappingData()
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_14.SPAWN_MOB,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                EntityPackets1_14.this.addTrackedEntity(
                                    wrapper, wrapper.get(Type.VAR_INT, 0), entityType
                                );
                                ...
                                if (oldId == -1) {
                                    ...
                                    if (entityData == null) {
                                        ViaBackwards.getPlatform()
                                            .getLogger()
                                            .warning(
                                                "Could not find 1.13.2 entity type for 1.14 entity type "
                                                    + type
                                                    + "/"
                                                    + entityType
                                            );
                        ...
                        this.handler(EntityPackets1_14.this.getMobSpawnRewriter1_11(Types1_13_2.METADATA_LIST));
                    }
                }
            );
        this.protocol
            .registerClientbound(
                ClientboundPackets1_14.SPAWN_EXPERIENCE_ORB,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.map(Type.DOUBLE);
                        this.handler(
                            wrapper -> EntityPackets1_14.this.addTrackedEntity(
                                wrapper, wrapper.get(Type.VAR_INT, 0), EntityTypes1_14.EXPERIENCE_ORB
                            )
                        );
                    }
                }
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_14.SPAWN_GLOBAL_ENTITY,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.handler(
                            wrapper -> EntityPackets1_14.this.addTrackedEntity(
                                wrapper, wrapper.get(Type.VAR_INT, 0), EntityTypes1_14.LIGHTNING_BOLT
                            )
                        );
                    }
                }
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_14.SPAWN_PAINTING,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.handler(
                            wrapper -> EntityPackets1_14.this.addTrackedEntity(
                                wrapper, wrapper.get(Type.VAR_INT, 0), EntityTypes1_14.PAINTING
                            )
                        );
                    }
                }
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_14.SPAWN_PLAYER,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.map(Types1_14.METADATA_LIST, Types1_13_2.METADATA_LIST);
                        this.handler(
                            EntityPackets1_14.this.getTrackerAndMetaHandler(
                                Types1_13_2.METADATA_LIST, EntityTypes1_14.PLAYER
                            )
                        );
                        this.handler(
                            wrapper -> EntityPackets1_14.this.positionHandler.cacheEntityPosition(wrapper, true, false)
                        );
                    }
                }
            );
        ...
        this.registerMetadataRewriter(
            ClientboundPackets1_14.ENTITY_METADATA, Types1_14.METADATA_LIST, Types1_13_2.METADATA_LIST
        );
    ...
    protected void registerRewrites() {
                ...
                (event, meta) -> {
                    ...
                    if (type != null) {
                        if (type.isOrHasParent(EntityTypes1_14.ABSTRACT_ILLAGER_BASE)
                            || type == EntityTypes1_14.RAVAGER
                            || type == EntityTypes1_14.WITCH) {
        ...
        this.filter()
            .type(EntityTypes1_14.AREA_EFFECT_CLOUD)
            .index(10)
            .handler((event, meta) -> this.rewriteParticle(event.user(), (Particle)meta.getValue()));
