...
public final class EntityPackets1_19_3 extends EntityRewriter<ClientboundPackets1_19_3, Protocol1_19_1To1_19_3> {
    ...
    protected void registerPackets() {
        this.registerMetadataRewriter(
            ClientboundPackets1_19_3.ENTITY_METADATA, Types1_19_3.METADATA_LIST, Types1_19.METADATA_LIST
        );
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_3.PLAYER_INFO_UPDATE,
                ClientboundPackets1_19_1.PLAYER_INFO,
                wrapper -> {
                    wrapper.cancel();
                    ...
                    if (actions.get(0)) {
                        ...
                        for (int i = 0; i < entries; i++) {
                            ...
                            updates[i] = new EntityPackets1_19_3.PlayerProfileUpdate(
                                uuid, gamemode, latency, displayName
                            );
                        }
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_3.PLAYER_INFO_REMOVE, ClientboundPackets1_19_1.PLAYER_INFO, wrapper -> {
    ...
    private void sendPlayerProfileUpdate(
        UserConnection connection, int action, EntityPackets1_19_3.PlayerProfileUpdate[] updates
    ) throws Exception {
