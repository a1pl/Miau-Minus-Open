...
public final class Protocol1_19_1To1_19_3
    ...
    public static final ByteArrayType.OptionalByteArrayType OPTIONAL_SIGNATURE_BYTES_TYPE = new ByteArrayType.OptionalByteArrayType(
        256
    );
    ...
    private final TranslatableRewriter<ClientboundPackets1_19_3> translatableRewriter = new TranslatableRewriter<>(
    ...
    public Protocol1_19_1To1_19_3() {
        super(
            ClientboundPackets1_19_3.class,
            ClientboundPackets1_19_1.class,
            ServerboundPackets1_19_3.class,
    ...
    protected void registerPackets() {
        ...
        this.tagRewriter.registerGeneric(ClientboundPackets1_19_3.TAGS);
        ...
        this.registerClientbound(
            ClientboundPackets1_19_3.DECLARE_COMMANDS,
            wrapper -> {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (nodeType == 2) {
                        ...
                        Preconditions.checkArgument(
                            mappedArgumentTypeId != -1, "Unknown command argument type id: " + argumentTypeId
                        );
                        ...
                        wrapper -> {
                            ...
                            if (!isNonce) {
                                ...
                                wrapper.write(
                                    ...
                                    nonceStorage.nonce() != null ? nonceStorage.nonce() : new byte[0]
                                );
                            }
                        }
                    );
        ...
        this.registerServerbound(
            ServerboundPackets1_19_1.CHAT_MESSAGE,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.STRING);
                        ...
                        wrapper -> {
                            ...
                            if (chatSession != null) {
                                ...
                                byte[] signature = chatSession.signChatMessage(
                                    metadata, message, new PlayerMessageSignature[0]
                                );
        ...
        this.registerServerbound(
            ServerboundPackets1_19_1.CHAT_COMMAND,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.STRING);
                        ...
                        wrapper -> {
                            ...
                            if (chatSession != null && argumentsProvider != null) {
                                ...
                                for (Pair<String, String> argument : arguments) {
                                    byte[] signature = chatSession.signChatMessage(
                                        metadata, argument.value(), new PlayerMessageSignature[0]
                                    );
                ...
                public void register() {
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            JsonElement content = unsignedContent != null
                                ? unsignedContent
                                : ComponentUtil.plainToJson(plainContent);
                            Protocol1_19_1To1_19_3.this.translatableRewriter.processText(wrapper.user(), content);
                            ...
                            JsonElement result = Protocol1_19To1_19_1.decorateChatMessage(
                                wrapper.user().get(ChatTypeStorage1_19_3.class),
                                chatTypeId,
                                senderName,
                                targetName,
                                content
    ...
    private @Nullable String rewriteSound(PacketWrapper wrapper) throws Exception {
        Holder<SoundEvent> holder = wrapper.read(Type.SOUND_EVENT);
        if (holder.hasId()) {
            ...
            String soundIdentifier = holder.value().identifier();
