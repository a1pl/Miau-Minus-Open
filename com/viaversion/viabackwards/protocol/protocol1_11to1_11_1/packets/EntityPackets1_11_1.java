    ...
    protected void registerPackets() {
            ...
            .registerClientbound(
                ...
                new PacketHandlers() {
                    ...
                    public void register() {
                        ...
                        this.handler(
                            EntityPackets1_11_1.this.getObjectRewriter(
        ...
        this.protocol.registerClientbound(ClientboundPackets1_9_3.SPAWN_MOB, new PacketHandlers() {
            ...
            public void register() {
                ...
                this.handler(EntityPackets1_11_1.this.getMobSpawnRewriter1_11(Types1_9.METADATA_LIST));
            }
        });
            ...
            .registerClientbound(
                ...
                new PacketHandlers() {
                    ...
                    public void register() {
                        ...
                        this.map(Types1_9.METADATA_LIST);
                        this.handler(
                            EntityPackets1_11_1.this.getTrackerAndMetaHandler(
