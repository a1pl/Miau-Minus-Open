...
public class BlockItemPackets1_15
    extends BackwardsItemRewriter<ClientboundPackets1_15, ServerboundPackets1_14, Protocol1_14_4To1_15> {
    ...
    protected void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_15.CHUNK_DATA,
                wrapper -> {
                            ...
                            wrapper -> {
                                ...
                                if (id == 3 || id == 23) {
                                    ...
                                    wrapper.set(
                                        Type.VAR_INT,
                                        0,
                                        BlockItemPackets1_15.this.protocol.getMappingData().getNewBlockStateId(data)
                                    );
                                } else if (id == 32) {
                                    Item item = BlockItemPackets1_15.this.handleItemToClient(
