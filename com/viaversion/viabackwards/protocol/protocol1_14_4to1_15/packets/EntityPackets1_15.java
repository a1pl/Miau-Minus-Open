...
public class EntityPackets1_15 extends EntityRewriter<ClientboundPackets1_15, Protocol1_14_4To1_15> {
    ...
    protected void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_15.GAME_EVENT,
                new PacketHandlers() {
                    @Override
                        ...
                        this.handler(
                            wrapper -> {
                                if (wrapper.get(Type.UNSIGNED_BYTE, 0) == 11) {
                                    wrapper.user()
                                        .get(ImmediateRespawn.class)
                                        .setImmediateRespawn(wrapper.get(Type.FLOAT, 0) == 1.0F);
                                }
                            }
                        );
                    }
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_15.SPAWN_MOB,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                EntityPackets1_15.this.<EntityTracker>tracker(wrapper.user())
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_15.ENTITY_PROPERTIES,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                EntityType entityType = EntityPackets1_15.this.<EntityTracker>tracker(wrapper.user())
                                    .entityType(entityId);
    ...
    protected void registerRewrites() {
        ...
        this.mapEntityTypeWithData(EntityTypes1_15.BEE, EntityTypes1_15.PUFFERFISH)
            .jsonName()
            .spawnMetadata(storage -> {
        ...
        this.filter()
            ...
            .index(8)
            .handler(
                (event, meta) -> event.createExtraMeta(
                    new Metadata(17, Types1_14.META_TYPES.floatType, event.meta().value())
                )
            );
    }
