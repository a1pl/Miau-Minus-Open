...
public class Protocol1_15_2To1_16
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(
            ClientboundPackets1_16.CHAT_MESSAGE,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.handler(
                        wrapper -> Protocol1_15_2To1_16.this.translatableRewriter
        ...
        this.registerClientbound(
            ClientboundPackets1_16.OPEN_WINDOW,
            new PacketHandlers() {
                @Override
                public void register() {
    ...
    public void init(UserConnection user) {
        ...
        user.addEntityTracker(
            (Class<? extends Protocol>)this.getClass(), new EntityTrackerBase(user, EntityTypes1_16.PLAYER)
        );
    }
