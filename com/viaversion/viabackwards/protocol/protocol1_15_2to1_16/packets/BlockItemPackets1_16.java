...
public class BlockItemPackets1_16
    extends BackwardsItemRewriter<ClientboundPackets1_16, ServerboundPackets1_14, Protocol1_15_2To1_16> {
    ...
    protected void registerPackets() {
        ...
        this.protocol.registerClientbound(ClientboundPackets1_16.ENTITY_EQUIPMENT, wrapper -> {
            ...
            do {
                ...
                Item item = this.handleItemToClient(wrapper.user(), wrapper.read(Type.ITEM1_13_2));
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_16.CHUNK_DATA,
                wrapper -> {
                    ...
                    for (Tag heightMapTag : heightMaps.values()) {
                        if (heightMapTag instanceof LongArrayTag) {
                            ...
                            CompactArrayUtil.iterateCompactArrayWithPadding(
                                9, heightMapData.length, heightMap.getValue(), (ix, v) -> heightMapData[ix] = v
                            );
                            heightMap.setValue(
                                CompactArrayUtil.createCompactArray(9, heightMapData.length, ix -> heightMapData[ix])
                            );
                        }
                    }
                    ...
                    if (chunk.isBiomeData()) {
                        if (wrapper.user()
                            ...
                            .newerThanOrEqualTo(ProtocolVersion.v1_16_2)) {
                            ...
                            for (int i = 0; i < 1024; i++) {
                                ...
                                if (legacyBiome == -1) {
                                    ViaBackwards.getPlatform()
                                        .getLogger()
                                        .warning("Biome sent that does not exist in the biome registry: " + biome);
                                    legacyBiome = 1;
                                }
        ...
        this.protocol
            .registerServerbound(
                ServerboundPackets1_14.EDIT_BOOK,
        ...
        if (item.identifier() == 759 && tag != null) {
            ...
            if (pagesTag != null) {
                for (StringTag page : pagesTag) {
                    JsonElement jsonElement = this.protocol
                        .getTranslatableRewriter()
                        .processText(connection, page.getValue());
