...
public class SoundPackets1_13 extends RewriterBase<Protocol1_12_2To1_13> {
    ...
    protected void registerPackets() {
        this.protocol
            .registerClientbound(
                ClientboundPackets1_13.NAMED_SOUND,
                wrapper -> {
                    String sound = wrapper.read(Type.STRING);
                    String mappedSound = NamedSoundMapping.getOldId(sound);
                    if (mappedSound == null
                        && (mappedSound = this.protocol.getMappingData().getMappedNamedSound(sound)) == null) {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_13.STOP_SOUND, ClientboundPackets1_12_1.PLUGIN_MESSAGE, wrapper -> {
                    ...
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                int oldSound = SoundPackets1_13.this.protocol
                                    .getMappingData()
                                    .getSoundMappings()
                                    .getNewId(newSound);
                                if (oldSound == -1) {
