...
public class BlockItemPackets1_12
    ...
    protected void registerPackets() {
        this.registerBlockChange(ClientboundPackets1_12.BLOCK_CHANGE);
        this.registerMultiBlockChange(ClientboundPackets1_12.MULTI_BLOCK_CHANGE);
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_12.PLUGIN_MESSAGE,
                new PacketHandlers() {
                    @Override
                    public void register() {
                            ...
                            wrapper -> {
                                if (wrapper.get(Type.STRING, 0).equals("MC|TrList")) {
                                    ...
                                    for (int i = 0; i < size; i++) {
                                        wrapper.write(
                                            Type.ITEM1_8,
                                            BlockItemPackets1_12.this.handleItemToClient(
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    if (wrapper.get(Type.VAR_INT, 0) == 1) {
                        ...
                        BlockItemPackets1_12.this.handleItemToServer(wrapper.user(), item);
                    }
                });
            }
        });
    ...
    private LongArrayTag fromIntArrayTag(IntArrayTag tag) {
        ...
        for (int j = 0; i < intArray.length; j++) {
            longArray[j] = (long)intArray[i] << 32 | intArray[i + 1] & 4294967295L;
            i += 2;
        }
