...
public class EntityPackets1_12 extends LegacyEntityRewriter<ClientboundPackets1_12, Protocol1_11_1To1_12> {
    ...
    protected void registerPackets() {
        this.protocol
            .registerClientbound(
                ClientboundPackets1_12.SPAWN_ENTITY,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        ...
                        this.handler(
                            EntityPackets1_12.this.getObjectRewriter(
                                id -> EntityTypes1_12.ObjectType.findById(id).orElse(null)
                            )
                        );
                        this.handler(EntityPackets1_12.this.protocol.getItemRewriter().getFallingBlockHandler());
                    }
                }
            );
        ...
        this.protocol.registerClientbound(ClientboundPackets1_12.SPAWN_MOB, new PacketHandlers() {
            ...
            public void register() {
                ...
                this.handler(EntityPackets1_12.this.getMobSpawnRewriter1_11(Types1_12.METADATA_LIST));
            }
        });
        this.registerTracker(ClientboundPackets1_12.SPAWN_PAINTING, EntityTypes1_12.EntityType.PAINTING);
        this.protocol
            .registerClientbound(
                ClientboundPackets1_12.SPAWN_PLAYER,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.map(Types1_12.METADATA_LIST);
                        this.handler(
                            EntityPackets1_12.this.getTrackerAndMetaHandler(
                                Types1_12.METADATA_LIST, EntityTypes1_12.EntityType.PLAYER
                            )
                        );
                    }
                }
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_12.JOIN_GAME,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.INT);
                        ...
                        this.map(Type.INT);
                        this.handler(
                            EntityPackets1_12.this.getTrackerHandler(EntityTypes1_12.EntityType.PLAYER, Type.INT)
                        );
                        ...
                        this.handler(
                            packetWrapper -> {
                                PacketWrapper wrapper = PacketWrapper.create(
                                    ClientboundPackets1_9_3.STATISTICS, packetWrapper.user()
                                );
    ...
    protected void registerRewrites() {
        ...
        this.mapEntityTypeWithData(
                EntityTypes1_12.EntityType.ILLUSION_ILLAGER, EntityTypes1_12.EntityType.EVOCATION_ILLAGER
            )
            .plainName();
