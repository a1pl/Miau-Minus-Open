                ...
                if (AchievementTranslationMapping.get(textValue) == null) {
                    ...
                    try {
                        ...
                        if (textValue.startsWith("achievement")) {
                            ...
                            namePart.addProperty(
                                "color", AchievementTranslationMapping.isSpecial(textValue) ? "dark_purple" : "green"
                            );
                        ...
                        if (!Via.getConfig().isSuppressConversionWarnings() || Via.getManager().isDebug()) {
                            Via.getPlatform()
                                .getLogger()
                                .log(Level.WARNING, "Error rewriting show_achievement: " + hoverEvent, e);
                        }
