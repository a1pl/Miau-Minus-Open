...
public class Protocol1_12To1_11_1
    ...
    public Protocol1_12To1_11_1() {
        super(
            ...
            ClientboundPackets1_12.class,
            ServerboundPackets1_9_3.class,
            ServerboundPackets1_12.class
        );
    }
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(
            ...
            new PacketHandlers() {
                ...
                public void register() {
                    ...
                    this.handler(
                        Protocol1_12To1_11_1.this.metadataRewriter.trackerAndRewriterHandler(Types1_12.METADATA_LIST)
                    );
                }
            }
        );
        ...
        this.metadataRewriter
            .registerMetadataRewriter(ClientboundPackets1_9_3.ENTITY_METADATA, Types1_12.METADATA_LIST);
        this.registerClientbound(
                        ...
                        wrapper -> {
                            ...
                            if (user.getProtocolInfo().protocolVersion().newerThanOrEqualTo(ProtocolVersion.v1_13)) {
                                wrapper.create(
                                        ...
                                        packetWrapper -> packetWrapper.write(Type.VAR_INT, 0)
                                    )
    ...
    public void init(UserConnection userConnection) {
        userConnection.addEntityTracker(
            ...
            new EntityTrackerBase(userConnection, EntityTypes1_12.EntityType.PLAYER)
        );
