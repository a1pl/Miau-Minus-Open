...
public final class Protocol1_19To1_18_2
    ...
    public static JsonElement mapTextComponentIfNull(JsonElement component) {
        return !isTextComponentNull(component) ? component : ComponentUtil.emptyJsonComponent();
    }

    @Override
    protected void registerPackets() {
        this.tagRewriter.registerGeneric(ClientboundPackets1_18.TAGS);
        ...
        PacketHandler singleNullTextComponentMapper = wrapper -> wrapper.write(
            Type.COMPONENT, mapTextComponentIfNull(wrapper.read(Type.COMPONENT))
        );
        ...
        this.registerClientbound(
            ClientboundPackets1_18.CHAT_MESSAGE, ClientboundPackets1_19.SYSTEM_CHAT, new PacketHandlers() {
                @Override
                public void register() {
        ...
        this.registerServerbound(
            ServerboundPackets1_19.CHAT_COMMAND, ServerboundPackets1_17.CHAT_MESSAGE, new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.STRING);
                    this.read(Type.LONG);
