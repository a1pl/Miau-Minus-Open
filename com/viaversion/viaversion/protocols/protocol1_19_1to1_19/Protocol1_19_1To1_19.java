...
public final class Protocol1_19_1To1_19
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_19.SERVER_DATA, new PacketHandlers() {
            ...
            public void register() {
                ...
                this.map(Type.BOOLEAN);
                this.create(Type.BOOLEAN, Via.getConfig().enforceSecureChat());
            }
        });
        this.registerServerbound(
            State.LOGIN,
    ...
    public static @Nullable ChatDecorationResult decorateChatMessage(
        CompoundTag chatType,
        int chatTypeId,
        JsonElement senderName,
        @Nullable JsonElement teamName,
        JsonElement message
    ) {
        if (chatType == null) {
            Via.getPlatform()
        ...
        return decoration == null
            ...
            : new ChatDecorationResult(
                translatabaleComponentFromTag(decoration, senderName, teamName, message), overlay
            );
    }

    public static JsonElement translatabaleComponentFromTag(
        CompoundTag tag, JsonElement senderName, @Nullable JsonElement targetName, JsonElement message
    ) {
        ...
        if (styleTag != null) {
            ...
            for (Entry<String, TextFormatting> entry : TextFormatting.FORMATTINGS.entrySet()) {
                NumberTag formattingTag = styleTag.getNumberTag(entry.getKey());
            ...
            for (StringTag element : parameters) {
                ...
                switch (element.getValue()) {
                    ...
                    default:
                        Via.getPlatform()
                            .getLogger()
                            .warning("Unknown parameter for chat decoration: " + element.getValue());
                }
