...
public class EntityPackets {
    ...
    private static final String[] WORLD_NAMES = new String[]{
    ...
    public static void register(Protocol1_16To1_15_2 protocol) {
        ...
        protocol.registerClientbound(
            ClientboundPackets1_15.SPAWN_GLOBAL_ENTITY,
            ClientboundPackets1_16.SPAWN_ENTITY,
            wrapper -> {
                ...
                if (type != 1) {
                    ...
                    wrapper.user()
                        .<EntityTracker>getEntityTracker(Protocol1_16To1_15_2.class)
                        .addEntity(entityId, EntityTypes1_16.LIGHTNING_BOLT);
        ...
        metadataRewriter.registerMetadataRewriter(
            ClientboundPackets1_15.ENTITY_METADATA, Types1_14.METADATA_LIST, Types1_16.METADATA_LIST
        );
        ...
        protocol.registerClientbound(
            ClientboundPackets1_15.JOIN_GAME,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.INT);
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            wrapper.write(
                                Type.STRING_ARRAY,
                                Arrays.copyOf(EntityPackets.WORLD_NAMES, EntityPackets.WORLD_NAMES.length)
                            );
        ...
        protocol.registerClientbound(ClientboundPackets1_15.ENTITY_PROPERTIES, wrapper -> {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String attributeIdentifier = (String)AttributeMappings.attributeIdentifierMappings().get(key);
