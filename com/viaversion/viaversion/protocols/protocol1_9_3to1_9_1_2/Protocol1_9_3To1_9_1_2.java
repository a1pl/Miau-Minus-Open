...
public class Protocol1_9_3To1_9_1_2
    ...
    public static final ValueTransformer<Short, Short> ADJUST_PITCH = new ValueTransformer<Short, Short>(
        Type.UNSIGNED_BYTE, Type.UNSIGNED_BYTE
    ) {
        public Short transform(PacketWrapper wrapper, Short inputValue) throws Exception {
            return (short)Math.round(inputValue.shortValue() / 63.5F * 63.0F);
        }
    };
