...
public final class InventoryPackets
    ...
    public void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_17_1.SPAWN_PARTICLE,
                new PacketHandlers() {
                    @Override
                    public void register() {
                        this.map(Type.INT);
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                if (id == 2) {
                                    ...
                                    ParticleMappings mappings = InventoryPackets.this.protocol
                                        .getMappingData()
                                        .getParticleMappings();
                                    if (mappings.isBlockParticle(id)) {
                                        ...
                                        wrapper.set(
                                            Type.VAR_INT,
                                            0,
                                            InventoryPackets.this.protocol.getMappingData().getNewBlockStateId(data)
                                        );
