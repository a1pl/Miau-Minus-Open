        ...
        protocol.registerClientbound(
            ...
            wrapper -> {
                ...
                lightStorage.storeLight(
                    chunkX,
                    chunkZ,
                    new ChunkLightStorage.ChunkLight(
                        trustEdges,
                        skyLightMask,
                        blockLightMask,
                        emptySkyLightMask,
            ...
            wrapper -> {
                ...
                for (CompoundTag tag : oldChunk.getBlockEntities()) {
                    ...
                    if (xTag != null && yTag != null && zTag != null && idTag != null) {
                        ...
                        int typeId = BlockEntities.blockEntityIds().getInt(Key.stripMinecraftNamespace(id));
                        if (typeId == -1) {
                ...
                Chunk chunk = new Chunk1_18(
                    oldChunk.getX(), oldChunk.getZ(), sections, oldChunk.getHeightMap(), blockEntities
                );
                wrapper.write(
                    new ChunkType1_18(
                ...
                if (light == null) {
                    Via.getPlatform()
                        .getLogger()
                        .warning(
                            "No light data found for chunk at "
                                + chunk.getX()
                                + ", "
                                + chunk.getZ()
