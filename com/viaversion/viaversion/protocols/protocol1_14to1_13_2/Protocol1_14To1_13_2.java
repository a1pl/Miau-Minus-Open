...
public class Protocol1_14To1_13_2
    ...
    protected void registerPackets() {
        ...
        CommandRewriter<ClientboundPackets1_13> commandRewriter = new CommandRewriter<ClientboundPackets1_13>(this) {
            ...
            public @Nullable String handleArgumentType(String argumentType) {
                return argumentType.equals("minecraft:nbt")
        ...
        this.registerClientbound(
            ...
            wrapper -> {
                ...
                wrapper.write(
                    Type.VAR_INT_ARRAY_PRIMITIVE, new int[]{MAPPINGS.getNewBlockId(150), MAPPINGS.getNewBlockId(155)}
                );
    ...
    public void init(UserConnection userConnection) {
        userConnection.addEntityTracker(
            (Class<? extends Protocol>)this.getClass(), new EntityTracker1_14(userConnection)
        );
