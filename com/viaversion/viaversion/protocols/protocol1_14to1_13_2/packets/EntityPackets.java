...
public class EntityPackets {
    public static void register(Protocol1_14To1_13_2 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_13.SPAWN_EXPERIENCE_ORB, wrapper -> {
            ...
            metadataRewriter.<EntityTracker>tracker(wrapper.user()).addEntity(entityId, EntityTypes1_14.EXPERIENCE_ORB);
        });
        protocol.registerClientbound(
            ClientboundPackets1_13.SPAWN_GLOBAL_ENTITY,
            wrapper -> {
                int entityId = wrapper.passthrough(Type.VAR_INT);
                if (wrapper.passthrough(Type.BYTE) == 1) {
                    metadataRewriter.<EntityTracker>tracker(wrapper.user())
                        .addEntity(entityId, EntityTypes1_14.LIGHTNING_BOLT);
                }
            }
        );
        protocol.registerClientbound(
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            if (type1_14 != null) {
                                ...
                                wrapper.user()
                                    .<EntityTracker>getEntityTracker(Protocol1_14To1_13_2.class)
                                    .addEntity(entityId, type1_14);
                            }
        ...
        protocol.registerClientbound(
            ...
            new PacketHandlers() {
                ...
                public void register() {
                    ...
                    this.map(Type.BYTE);
                    this.handler(
                        wrapper -> metadataRewriter.<EntityTracker>tracker(wrapper.user())
                            .addEntity(wrapper.get(Type.VAR_INT, 0), EntityTypes1_14.PAINTING)
                    );
                }
            }
        );
        protocol.registerClientbound(
            ...
            new PacketHandlers() {
                ...
                public void register() {
                    ...
                    this.map(Types1_13_2.METADATA_LIST, Types1_14.METADATA_LIST);
                    this.handler(
                        metadataRewriter.trackerAndRewriterHandler(Types1_14.METADATA_LIST, EntityTypes1_14.PLAYER)
                    );
                }
            }
        );
        protocol.registerClientbound(
            ClientboundPackets1_13.ENTITY_ANIMATION,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.VAR_INT);
                            ...
                            if (animation == 2) {
                                ...
                                if (tracker.clientEntityId() != entityId) {
                                    metadataList.add(
                                        new Metadata(
                                            6,
                                            Types1_14.META_TYPES.poseType,
                                            MetadataRewriter1_14To1_13_2.recalculatePlayerPose(entityId, tracker)
                                        )
                                    );
                                }
        ...
        protocol.registerClientbound(
            ClientboundPackets1_13.USE_BED,
            ClientboundPackets1_14.ENTITY_METADATA,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.VAR_INT);
        ...
        metadataRewriter.registerMetadataRewriter(
            ClientboundPackets1_13.ENTITY_METADATA, Types1_13_2.METADATA_LIST, Types1_14.METADATA_LIST
        );
    }
}
