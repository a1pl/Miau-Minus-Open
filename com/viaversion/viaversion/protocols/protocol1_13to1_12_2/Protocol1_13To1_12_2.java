...
public class Protocol1_13To1_12_2
    ...
    private static final Set<Character> FORMATTING_CODES = Sets.newHashSet(
        new Character[]{'k', 'l', 'm', 'n', 'o', 'r'}
    );
    ...
    public Protocol1_13To1_12_2() {
        super(
            ClientboundPackets1_12_1.class,
            ClientboundPackets1_13.class,
            ServerboundPackets1_12_1.class,
            ServerboundPackets1_13.class
        );
    }
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(
            ...
            0,
            0,
            wrapper -> this.componentRewriter.processText(wrapper.user(), wrapper.passthrough(Type.COMPONENT))
        );
        ...
        this.registerClientbound(
            ClientboundPackets1_12_1.STATISTICS,
            wrapper -> {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (split.length == 2) {
                        ...
                        if (newIdRaw != null) {
                            ...
                            Via.getPlatform()
                                .getLogger()
                                .warning("Could not find 1.13 -> 1.12.2 statistic mapping for " + name);
                        }
        ...
        this.registerClientbound(
            ClientboundPackets1_12_1.OPEN_WINDOW,
            new PacketHandlers() {
                @Override
                public void register() {
                    ...
                    this.map(Type.STRING);
                    this.handler(
                        wrapper -> Protocol1_13To1_12_2.this.componentRewriter
        ...
        this.registerClientbound(
            ClientboundPackets1_12_1.EFFECT,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.INT);
                        ...
                        wrapper -> {
                            ...
                            if (id == 1010) {
                                wrapper.set(
                                    Type.INT,
                                    1,
                                    Protocol1_13To1_12_2.this.getMappingData()
                                        .getItemMappings()
                                        .getNewId(IdAndData.toRawData(data))
                                );
                            } else if (id == 2001) {
                ...
                public void register() {
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            if (action == 0) {
                                wrapper.create(
                                        ClientboundPackets1_13.DECLARE_RECIPES,
                                        w -> Protocol1_13To1_12_2.this.writeDeclareRecipes(w)
                                    )
        ...
        this.registerClientbound(ClientboundPackets1_12_1.TAB_LIST, wrapper -> {
            this.componentRewriter.processText(wrapper.user(), wrapper.passthrough(Type.COMPONENT));
            this.componentRewriter.processText(wrapper.user(), wrapper.passthrough(Type.COMPONENT));
        });
        ...
        this.registerServerbound(
            ServerboundPackets1_13.TAB_COMPLETE,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.handler(wrapper -> {
                    ...
                    this.handler(
                        wrapper -> {
                            wrapper.write(Type.BOOLEAN, false);
                            Position playerLookTarget = Via.getManager()
                                .getProviders()
                                .get(PlayerLookTargetProvider.class)
                                .getPlayerLookTarget(wrapper.user());
                            ...
                            if (!wrapper.isCancelled() && Via.getConfig().get1_13TabCompleteDelay() > 0) {
                                ...
                                wrapper.cancel();
                                tracker.setTimeToSend(
                                    System.currentTimeMillis() + Via.getConfig().get1_13TabCompleteDelay() * 50L
                                );
        ...
        this.registerServerbound(
            ServerboundPackets1_13.EDIT_BOOK, ServerboundPackets1_12_1.PLUGIN_MESSAGE, wrapper -> {
        ...
        this.registerServerbound(
            ServerboundPackets1_13.PICK_ITEM,
            ServerboundPackets1_12_1.PLUGIN_MESSAGE,
            wrapper -> wrapper.write(Type.STRING, "MC|PickItem")
        );
        ...
        this.registerServerbound(
            ServerboundPackets1_13.RENAME_ITEM,
            ServerboundPackets1_12_1.PLUGIN_MESSAGE,
            wrapper -> wrapper.write(Type.STRING, "MC|ItemName")
        );
        this.registerServerbound(
            ServerboundPackets1_13.SELECT_TRADE, ServerboundPackets1_12_1.PLUGIN_MESSAGE, new PacketHandlers() {
                @Override
                public void register() {
        ...
        this.registerServerbound(
            ServerboundPackets1_13.SET_BEACON_EFFECT, ServerboundPackets1_12_1.PLUGIN_MESSAGE, new PacketHandlers() {
                @Override
                public void register() {
        ...
        this.registerServerbound(
            ServerboundPackets1_13.UPDATE_COMMAND_BLOCK,
            ServerboundPackets1_12_1.PLUGIN_MESSAGE,
            new PacketHandlers() {
                @Override
                public void register() {
        ...
        this.registerServerbound(
            ServerboundPackets1_13.UPDATE_STRUCTURE_BLOCK,
            ServerboundPackets1_12_1.PLUGIN_MESSAGE,
            new PacketHandlers() {
                @Override
                public void register() {
                    ...
                    this.map(
                        Type.VAR_INT,
                        new ValueTransformer<Integer, String>(Type.STRING) {
                            public String transform(PacketWrapper wrapper, Integer rotation) throws Exception {
                                return rotation == 0
                                    ...
                                    : (
                                        rotation == 1
                                            ? "CLOCKWISE_90"
                                            : (rotation == 2 ? "CLOCKWISE_180" : "COUNTERCLOCKWISE_90")
                                    );
                            }
                        }
                    );
    ...
    public void init(UserConnection userConnection) {
        userConnection.addEntityTracker(
            (Class<? extends Protocol>)this.getClass(),
            new EntityTrackerBase(userConnection, EntityTypes1_13.EntityType.PLAYER)
        );
