...
public class BlockIdData {
    ...
    public static void init() {
        ...
        InputStream blockS = MappingData.class
            .getClassLoader()
        ...
        try (InputStreamReader blockR = new InputStreamReader(blockS)) {
            Map<Integer, String> map = GsonUtil.getGson()
                .fromJson(blockR, (new TypeToken<Map<Integer, String>>() {}).getType());
            numberIdToString = new Int2ObjectOpenHashMap<>(map);
        } catch (IOException e) {
            Via.getPlatform()
                .getLogger()
                .log(Level.SEVERE, "Failed to load block number to string mappings (1.12.2)", e);
        }
    }
}
