...
public class MappingData extends MappingDataBase {
    ...
    protected void loadExtras(CompoundTag data) {
                ...
                if (!Key.isValid(newChannel)) {
                    Via.getPlatform()
                        ...
                        .warning(
                            "Channel '"
                                + newChannel
                                + "' is not a valid 1.13 plugin channel, please check your configuration!"
                        );
                } else {
        ...
        try (Reader reader = new InputStreamReader(
                MappingData.class.getClassLoader().getResourceAsStream("assets/viaversion/data/en_US.properties"),
