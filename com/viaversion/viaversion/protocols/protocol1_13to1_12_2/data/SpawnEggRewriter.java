...
public class SpawnEggRewriter {
    ...
    public static int getSpawnEggId(String entityIdentifier) {
        return !spawnEggs.containsKey(entityIdentifier)
            ? -1
            : 25100288 | (Integer)spawnEggs.get(entityIdentifier) & 65535;
    }

    public static Optional<String> getEntityId(int spawnEggId) {
        return spawnEggId >> 16 != 383
            ? Optional.empty()
            : Optional.ofNullable((String)spawnEggs.inverse().get(spawnEggId & 65535));
    }
