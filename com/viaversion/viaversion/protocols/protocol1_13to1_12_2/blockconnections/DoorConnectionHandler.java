...
public class DoorConnectionHandler extends ConnectionHandler {
    ...
    public int connect(UserConnection user, Position position, int blockState) {
        ...
        if (doorData.isLower()) {
            DoorConnectionHandler.DoorData upperHalf = DOOR_DATA_MAP.get(
                this.getBlockData(user, position.getRelative(BlockFace.TOP))
            );
            if (upperHalf == null) {
                return blockState;
            }
            ...
            DoorConnectionHandler.DoorData lowerHalf = DOOR_DATA_MAP.get(
                this.getBlockData(user, position.getRelative(BlockFace.BOTTOM))
            );
            if (lowerHalf == null) {
                return blockState;
            }
