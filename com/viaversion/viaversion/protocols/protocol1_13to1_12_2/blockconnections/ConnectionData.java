                    ...
                    for (int idx = 0; idx < 4096; idx++) {
                        ...
                        if (handler != null) {
                            Position position = new Position(
                                xOff + ChunkSection.xFromIndex(idx),
                                yOff + ChunkSection.yFromIndex(idx),
                                zOff + ChunkSection.zFromIndex(idx)
                            );
    ...
    public static void init() {
        if (Via.getConfig().isServersideBlockConnections()) {
            ...
            if (!Via.getConfig().isReduceBlockStorageMemory()) {
                ...
                for (CompoundTag blockTag : MappingDataLoader.INSTANCE
                    .loadNBT("blockConnections.nbt")
                    .getListTag("data", CompoundTag.class)) {
                    ...
                    if (distance != 0) {
                        ...
                        if (!updates.isEmpty()) {
                            PacketWrapper wrapper = PacketWrapper.create(
                                ClientboundPackets1_13.MULTI_BLOCK_CHANGE, null, this.user
                            );
        ...
        private void updateBlock(int x, int y, int z, List<BlockChangeRecord1_8> records) {
            ...
            if (handler != null) {
                ...
                if (blockState != newBlockState
                    || !ConnectionData.blockConnectionProvider.storesBlocks(this.user, null)) {
