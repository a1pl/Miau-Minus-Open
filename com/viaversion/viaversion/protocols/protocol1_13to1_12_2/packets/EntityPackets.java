...
public class EntityPackets {
    public static void register(Protocol1_13To1_12_2 protocol) {
        ...
        protocol.registerClientbound(
            ClientboundPackets1_12_1.SPAWN_ENTITY,
            new PacketHandlers() {
                @Override
                public void register() {
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            if (entType != null) {
                                wrapper.user()
                                    .<EntityTracker>getEntityTracker(Protocol1_13To1_12_2.class)
        ...
        protocol.registerClientbound(
            ClientboundPackets1_12_1.SPAWN_PLAYER,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.VAR_INT);
                    ...
                    this.map(Types1_12.METADATA_LIST, Types1_13.METADATA_LIST);
                    this.handler(
                        metadataRewriter.trackerAndRewriterHandler(
        ...
        metadataRewriter.registerMetadataRewriter(
            ClientboundPackets1_12_1.ENTITY_METADATA, Types1_12.METADATA_LIST, Types1_13.METADATA_LIST
        );
    }
}
