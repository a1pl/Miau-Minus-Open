...
public final class EntityPackets extends EntityRewriter<ClientboundPackets1_19_3, Protocol1_19_4To1_19_3> {
    ...
    public void registerPackets() {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_3.SET_PASSENGERS,
                new PacketHandlers() {
                    @Override
                    protected void register() {
                        this.map(Type.VAR_INT);
                        ...
                        this.handler(
                            wrapper -> {
                                PlayerVehicleTracker playerVehicleTracker = wrapper.user()
                                    .get(PlayerVehicleTracker.class);
                                int clientEntityId = wrapper.user()
                                    .<EntityTracker>getEntityTracker(Protocol1_19_4To1_19_3.class)
                                    .clientEntityId();
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_3.ENTITY_TELEPORT,
                new PacketHandlers() {
                    @Override
                    protected void register() {
                        this.handler(
                            wrapper -> {
                                ...
                                if (entityId != clientEntityId) {
                                    ...
                                    wrapper.passthrough(Type.DOUBLE);
                                    wrapper.passthrough(Type.DOUBLE);
                                    wrapper.write(Type.FLOAT, wrapper.read(Type.BYTE).byteValue() * 360.0F / 256.0F);
                                    wrapper.write(Type.FLOAT, wrapper.read(Type.BYTE).byteValue() * 360.0F / 256.0F);
        ...
        this.registerMetadataRewriter(
            ClientboundPackets1_19_3.ENTITY_METADATA, Types1_19_3.METADATA_LIST, Types1_19_4.METADATA_LIST
        );
    }
