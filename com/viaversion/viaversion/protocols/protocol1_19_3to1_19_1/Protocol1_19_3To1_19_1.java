...
public final class Protocol1_19_3To1_19_1
    ...
    protected void registerPackets() {
        ...
        this.tagRewriter
            .addEmptyTags(
                RegistryType.ITEM, "minecraft:bookshelf_books", "minecraft:hanging_signs", "minecraft:stripped_logs"
            );
        this.tagRewriter
            .addEmptyTags(
                RegistryType.BLOCK,
        ...
        this.registerClientbound(ClientboundPackets1_19_1.ENTITY_SOUND, soundHandler);
                ...
                public void register() {
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            if (!signature.uuid().equals(Protocol1_19_3To1_19_1.ZERO_UUID)
                                && signature.signatureBytes().length != 0) {
                                ReceivedMessagesStorage messagesStorage = wrapper.user()
                                    .get(ReceivedMessagesStorage.class);
                                ...
                                if (messagesStorage.tickUnacknowledged() > 64) {
                                    ...
                                    chatAckPacket.write(
                                        Type.PLAYER_MESSAGE_SIGNATURE_ARRAY, messagesStorage.lastSignatures()
                                    );
        ...
        this.registerServerbound(
            ServerboundPackets1_19_3.CHAT_COMMAND,
            new PacketHandlers() {
                @Override
                public void register() {
                    ...
                    this.read(Type.ACKNOWLEDGED_BIT_SET);
                }
            }
        );
        this.registerServerbound(
            ServerboundPackets1_19_3.CHAT_MESSAGE,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.STRING);
