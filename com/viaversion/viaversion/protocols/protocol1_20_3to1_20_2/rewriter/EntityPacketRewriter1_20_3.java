...
public final class EntityPacketRewriter1_20_3 extends EntityRewriter<ClientboundPacket1_20_2, Protocol1_20_3To1_20_2> {
    ...
    public void registerPackets() {
        ...
        this.registerMetadataRewriter(
            ClientboundPackets1_20_2.ENTITY_METADATA, Types1_20_2.METADATA_LIST, Types1_20_3.METADATA_LIST
        );
        ...
        this.protocol.registerClientbound(ClientboundPackets1_20_2.WORLD_BORDER_INIT, this::sendChunksSentGameEvent);
    }
                ...
                (event, meta) -> {
                    ...
                    if (type == Types1_20_2.META_TYPES.componentType) {
                        meta.setTypeAndValue(
                            Types1_20_3.META_TYPES.componentType, ComponentUtil.jsonToTag(meta.value())
                        );
                    } else if (type == Types1_20_2.META_TYPES.optionalComponentType) {
                        meta.setTypeAndValue(
                            Types1_20_3.META_TYPES.optionalComponentType, ComponentUtil.jsonToTag(meta.value())
                        );
                    } else {
