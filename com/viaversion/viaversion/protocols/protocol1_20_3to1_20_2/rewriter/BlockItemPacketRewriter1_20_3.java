...
public final class BlockItemPacketRewriter1_20_3
    extends ItemRewriter<ClientboundPacket1_20_2, ServerboundPacket1_20_3, Protocol1_20_3To1_20_2> {
    ...
    public void registerPackets() {
                    ...
                    public void register() {
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                ParticleMappings particleMappings = BlockItemPacketRewriter1_20_3.this.protocol
                                    .getMappingData()
                                    .getParticleMappings();
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_20_2.EXPLOSION,
                wrapper -> {
                    ...
                    wrapper.write(
                        ...
                        new Particle(this.protocol.getMappingData().getParticleMappings().mappedId("explosion"))
                    );
                    wrapper.write(
                        Types1_20_3.PARTICLE,
                        new Particle(this.protocol.getMappingData().getParticleMappings().mappedId("explosion_emitter"))
                    );
    ...
    private void updatePages(CompoundTag tag, String key) {
        ListTag<StringTag> pages = tag.getListTag(key, StringTag.class);
        if (pages != null) {
            for (StringTag pageTag : pages) {
                try {
                    JsonElement updatedComponent = ComponentUtil.convertJson(
                        pageTag.getValue(), SerializerVersion.V1_19_4, SerializerVersion.V1_20_3
                    );
