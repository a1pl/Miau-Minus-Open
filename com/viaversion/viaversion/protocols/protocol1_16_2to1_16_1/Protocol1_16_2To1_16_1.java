...
public class Protocol1_16_2To1_16_1
    ...
    protected void registerPackets() {
        ...
        this.registerServerbound(
            ServerboundPackets1_16_2.SEEN_RECIPE, ServerboundPackets1_16.RECIPE_BOOK_DATA, wrapper -> {
    ...
    public void init(UserConnection userConnection) {
        userConnection.addEntityTracker(
            (Class<? extends Protocol>)this.getClass(), new EntityTrackerBase(userConnection, EntityTypes1_16_2.PLAYER)
        );
    }
