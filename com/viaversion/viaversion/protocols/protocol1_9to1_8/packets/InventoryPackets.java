...
public class InventoryPackets {
    public static void register(Protocol1_9To1_8 protocol) {
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            if (showShieldWhenSwordInHand) {
                                InventoryTracker inventoryTracker = wrapper.user().get(InventoryTracker.class);
                                EntityTracker1_9 entityTracker = wrapper.user()
                                    .getEntityTracker(Protocol1_9To1_8.class);
        ...
        protocol.registerServerbound(
            ServerboundPackets1_9.CREATIVE_INVENTORY_ACTION,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.SHORT);
        ...
        protocol.registerServerbound(
            ServerboundPackets1_9.CLICK_WINDOW,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.UNSIGNED_BYTE);
        ...
        protocol.registerServerbound(
            ServerboundPackets1_9.HELD_ITEM_CHANGE,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.SHORT);
