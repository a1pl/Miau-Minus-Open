        ...
        if (id == 387) {
            ...
            if (pages != null) {
                for (int i = 0; i < pages.size(); i++) {
                    ...
                    pageTag.setValue(
                        ComponentUtil.convertJson(value, SerializerVersion.V1_9, SerializerVersion.V1_8).toString()
                    );
                }
            }
        }
    ...
    public static void toClient(Item item) {
        if (item != null) {
            ...
            if (item.identifier() == 387) {
                ...
                if (pages == null) {
                    pages = new ListTag<>(
                        Collections.singletonList(new StringTag(ComponentUtil.emptyJsonComponent().toString()))
                    );
                    tag.put("pages", pages);
                    item.setTag(tag);
                    return;
                ...
                for (int i = 0; i < pages.size(); i++) {
                    ...
                    page.setValue(
                        ComponentUtil.convertJsonOrEmpty(
                                page.getValue(), SerializerVersion.V1_8, SerializerVersion.V1_9
                            )
                            .toString()
                    );
                }
