...
public final class Protocol1_18_2To1_18
    ...
    protected void registerPackets() {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (CompoundTag dimension : TagUtil.getRegistryEntries(registry, "dimension_type")) {
                        Protocol1_18_2To1_18.this.addTagPrefix(dimension.getCompoundTag("element"));
                    }
        ...
        this.registerClientbound(
            ClientboundPackets1_18.RESPAWN, wrapper -> this.addTagPrefix(wrapper.passthrough(Type.NAMED_COMPOUND_TAG))
        );
    }
