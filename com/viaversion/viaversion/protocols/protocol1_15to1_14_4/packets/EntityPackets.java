...
public final class EntityPackets {
    public static void register(Protocol1_15To1_14_4 protocol) {
        ...
        protocol.registerClientbound(
            ClientboundPackets1_14_4.SPAWN_MOB,
            new PacketHandlers() {
                @Override
                public void register() {
                    ...
                    this.handler(
                        wrapper -> EntityPackets.sendMetadataPacket(
                            wrapper, wrapper.get(Type.VAR_INT, 0), metadataRewriter
                        )
                    );
                }
            }
        ...
        protocol.registerClientbound(
            ClientboundPackets1_14_4.SPAWN_PLAYER,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.VAR_INT);
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            wrapper.user()
                                .<EntityTracker>getEntityTracker(Protocol1_15To1_14_4.class)
                                .addEntity(entityId, EntityTypes1_15.PLAYER);
