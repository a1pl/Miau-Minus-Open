...
public final class EntityPacketRewriter1_20_2 extends EntityRewriter<ClientboundPackets1_19_4, Protocol1_20_2To1_20> {
    ...
    public void registerPackets() {
        ...
        this.registerMetadataRewriter(
            ClientboundPackets1_19_4.ENTITY_METADATA, Types1_20.METADATA_LIST, Types1_20_2.METADATA_LIST
        );
        this.registerRemoveEntities(ClientboundPackets1_19_4.REMOVE_ENTITIES);
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_4.SPAWN_PLAYER, ClientboundPackets1_20_2.SPAWN_ENTITY, wrapper -> {
        ...
        this.protocol
            .registerClientbound(
                ClientboundPackets1_19_4.JOIN_GAME,
                new PacketHandlers() {
                    @Override
                        ...
                        this.handler(
                            wrapper -> {
                                ...
                                if (!configurationBridge.setLastDimensionRegistry(dimensionRegistry)) {
                                    PacketWrapper clientInformationPacket = configurationBridge.clientInformationPacket(
                                        wrapper.user()
                                    );
                                    ...
                                    PacketWrapper configurationPacket = wrapper.create(
                                        ClientboundPackets1_20_2.START_CONFIGURATION
                                    );
                                    configurationPacket.send(Protocol1_20_2To1_20.class);
                                    configurationBridge.setBridgePhase(
                                        ConfigurationState.BridgePhase.REENTERING_CONFIGURATION
                                    );
                                    ...
                                    configurationBridge.setJoinGamePacket(wrapper);
                                    wrapper.cancel();
                                    Protocol1_20_2To1_20.sendConfigurationPackets(
                                        wrapper.user(), dimensionRegistry, null
                                    );
                                }
                            }
                        );
        ...
        this.protocol.registerClientbound(ClientboundPackets1_19_4.ENTITY_EFFECT, wrapper -> {
            ...
            wrapper.passthrough(Type.VAR_INT);
            wrapper.passthrough(Type.BYTE);
            wrapper.write(Type.OPTIONAL_COMPOUND_TAG, wrapper.read(Type.OPTIONAL_NAMED_COMPOUND_TAG));
        });
