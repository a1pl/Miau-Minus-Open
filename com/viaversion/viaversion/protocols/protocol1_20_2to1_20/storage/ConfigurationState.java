...
public class ConfigurationState implements StorableObject {
    ...
    private ConfigurationState.QueuedPacket toQueuedPacket(
        PacketWrapper wrapper, boolean clientbound, boolean skipCurrentPipeline
    ) throws Exception {
    ...
    public static final class QueuedPacket {
        ...
        private QueuedPacket(
            ByteBuf buf, boolean clientbound, PacketType packetType, int packetId, boolean skipCurrentPipeline
        ) {
            this.buf = buf;
