...
public interface PacketWrapper {
    ...
    static PacketWrapper create(
        @Nullable PacketType packetType, @Nullable ByteBuf inputBuffer, UserConnection connection
    ) {
    ...
    void apply(Direction var1, State var2, List<Protocol> var3) throws Exception;
    ...
    default PacketWrapper apply(Direction direction, State state, int index, List<Protocol> pipeline) throws Exception {
        return this.apply(direction, state, index, pipeline, false);
    }
