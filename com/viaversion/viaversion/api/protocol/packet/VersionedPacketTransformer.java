...
public interface VersionedPacketTransformer<C extends ClientboundPacketType, S extends ServerboundPacketType> {
    ...
    @Nullable PacketWrapper transform(PacketWrapper var1) throws Exception;

    @Nullable PacketWrapper transform(UserConnection var1, C var2, Consumer<PacketWrapper> var3) throws Exception;

    @Nullable PacketWrapper transform(UserConnection var1, S var2, Consumer<PacketWrapper> var3) throws Exception;
}
