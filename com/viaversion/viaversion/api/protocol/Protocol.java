...
public interface Protocol<CU extends ClientboundPacketType, CM extends ClientboundPacketType, SM extends ServerboundPacketType, SU extends ServerboundPacketType> {
    ...
    default void registerServerbound(
        State state, int unmappedPacketId, int mappedPacketId, @Nullable PacketHandler handler
    ) {
    ...
    void appendClientbound(CU var1, PacketHandler var2);

    void appendServerbound(SU var1, PacketHandler var2);
    ...
    @Deprecated
    default void registerClientbound(
        State state, int unmappedPacketId, int mappedPacketId, PacketRemapper packetRemapper
    ) {
    ...
    @Deprecated
    default void registerClientbound(
        State state, int unmappedPacketId, int mappedPacketId, PacketRemapper packetRemapper, boolean override
    ) {
    ...
    @Deprecated
    default void registerClientbound(
        CU packetType, @Nullable CM mappedPacketType, @Nullable PacketRemapper packetRemapper
    ) {
    ...
    @Deprecated
    default void registerClientbound(
        CU packetType, @Nullable CM mappedPacketType, @Nullable PacketRemapper packetRemapper, boolean override
    ) {
    ...
    @Deprecated
    default void registerServerbound(
        SU packetType, @Nullable SM mappedPacketType, @Nullable PacketRemapper packetRemapper
    ) {
    ...
    @Deprecated
    default void registerServerbound(
        SU packetType, @Nullable SM mappedPacketType, @Nullable PacketRemapper packetRemapper, boolean override
    ) {
