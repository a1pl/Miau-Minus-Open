...
public interface UserConnection {
    <T extends StorableObject> @Nullable T get(Class<T> var1);

    boolean has(Class<? extends StorableObject> var1);

    <T extends StorableObject> @Nullable T remove(Class<T> var1);

    void put(StorableObject var1);

    Collection<EntityTracker> getEntityTrackers();

    <T extends EntityTracker> @Nullable T getEntityTracker(Class<? extends Protocol> var1);
