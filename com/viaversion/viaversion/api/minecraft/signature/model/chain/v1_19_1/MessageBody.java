...
public class MessageBody {
    ...
    public MessageBody(
        DecoratableMessage content, Instant timestamp, long salt, PlayerMessageSignature[] lastSeenMessages
    ) {
        ...
        try {
            ...
            if (this.content.isDecorated()) {
                dataOutputStream.write(
                    GsonUtil.sort(this.content.decorated()).toString().getBytes(StandardCharsets.UTF_8)
                );
            }
