        ...
        if (src instanceof StringComponent) {
            ...
            if (stringComponent.getSiblings().isEmpty()) {
                ...
                for (ATextComponent sibling : stringComponent.getSiblings()) {
                    if (sibling instanceof StringComponent
                        && sibling.getStyle().isEmpty()
                        && sibling.getSiblings().isEmpty()) {
                ...
                if (args.length == 1 && args[0] instanceof String) {
                    ...
                    for (Object arg : args) {
                        if (arg instanceof String) {
                            ...
                            if ((stringComponent.getStyle() == null || stringComponent.getStyle().isEmpty())
                                && stringComponent.getSiblings().isEmpty()) {
                            ...
                            if (!(arg instanceof TranslationComponent)) {
                                throw new IllegalArgumentException(
                                    "Minecraft 1.9 did not support translation arguments of type "
