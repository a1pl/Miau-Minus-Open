...
import com.viaversion.viaversion.libs.mcstructs.text.utils.LegacyGsonCheck;
...
public class TextComponentSerializer {
    ...
    public static final TextComponentSerializer V1_16 = new TextComponentSerializer(
        () -> new GsonBuilder()
            ...
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventDeserializer_v1_16(V1_16, SNbtSerializer.V1_14)
            )
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventSerializer_v1_16(V1_16, SNbtSerializer.V1_14)
            )
            .disableHtmlEscaping()
            .create()
    );
    public static final TextComponentSerializer V1_17 = new TextComponentSerializer(
        () -> new GsonBuilder()
            ...
            .registerTypeAdapter(Style.class, new StyleSerializer_v1_16())
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventDeserializer_v1_16(V1_17, SNbtSerializer.V1_14)
            )
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventSerializer_v1_16(V1_17, SNbtSerializer.V1_14)
            )
            .disableHtmlEscaping()
            .create()
    );
    public static final TextComponentSerializer V1_18 = new TextComponentSerializer(
        () -> new GsonBuilder()
            ...
            .registerTypeAdapter(Style.class, new StyleSerializer_v1_16())
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventDeserializer_v1_18(V1_18, SNbtSerializer.V1_14)
            )
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventSerializer_v1_16(V1_18, SNbtSerializer.V1_14)
            )
            .disableHtmlEscaping()
            .create()
    );
    public static final TextComponentSerializer V1_19_4 = new TextComponentSerializer(
        () -> new GsonBuilder()
            ...
            .registerTypeAdapter(Style.class, new StyleSerializer_v1_16())
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventDeserializer_v1_18(V1_19_4, SNbtSerializer.V1_14)
            )
            .registerTypeHierarchyAdapter(
                AHoverEvent.class, new HoverEventSerializer_v1_16(V1_19_4, SNbtSerializer.V1_14)
            )
            .disableHtmlEscaping()
            .create()
    );
    ...
    public TextComponentSerializer(Supplier<Gson> gsonSupplier, boolean legacyGsonCheck) {
    ...
    public ATextComponent deserializeParser(String json) {
        return this.parentCodec != null
            ? this.parentCodec.deserializeJson(json)
            : this.getGson().fromJson(JsonParser.parseString(json), ATextComponent.class);
    }

    public ATextComponent deserializeLenientReader(String json) {
        return this.parentCodec != null
            ? this.parentCodec.deserializeLenientJson(json)
            : this.deserializeReader(json, true);
    }

    public ATextComponent deserializeReader(String json, boolean lenient) {
        if (this.legacyGsonCheck) {
            LegacyGsonCheck.check(json, lenient);
        }

        if (this.parentCodec != null) {
            return lenient
                ? this.parentCodec.deserializeLenientJson(json)
                : this.parentCodec.deserializeJsonReader(json);
        }
