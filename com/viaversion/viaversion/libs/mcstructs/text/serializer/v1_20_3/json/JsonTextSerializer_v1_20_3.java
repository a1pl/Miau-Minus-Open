...
public class JsonTextSerializer_v1_20_3 implements ITypedSerializer<JsonElement, ATextComponent>, CodecUtils_v1_20_3 {
    ...
    public JsonTextSerializer_v1_20_3(
        Function<JsonTextSerializer_v1_20_3, ITypedSerializer<JsonElement, Style>> styleSerializer
    ) {
            ...
            if (!this.containsString(obj, "text") || type != null && !type.equals("text")) {
                if (!this.containsString(obj, "translate") || type != null && !type.equals("translatable")) {
                    if (!this.containsString(obj, "keybind") || type != null && !type.equals("keybind")) {
                        if (!this.containsObject(obj, "score")
                            || !this.containsString(obj.getAsJsonObject("score"), "name")
                            || !this.containsString(obj.getAsJsonObject("score"), "objective")
                            ...
                            if (!this.containsString(obj, "selector") || type != null && !type.equals("selector")) {
                                if (!this.containsString(obj, "nbt") || type != null && !type.equals("nbt")) {
                                    throw new IllegalArgumentException(
                                        "Unknown component type: " + obj.getClass().getSimpleName()
                                    );
                                }
                                ...
                                if (!this.containsString(obj, "entity") || source != null && !source.equals("entity")) {
                                    if (!this.containsString(obj, "block") || source != null && !source.equals("block")
                                     ...
                                     {
                                        if (this.containsString(obj, "storage")
                                            ...
                                            try {
                                                component = new StorageNbtComponent(
                                                    ...
                                                    interpret,
                                                    separator,
                                                    Identifier.of(obj.get("storage").getAsString())
                                                );
                                                typeFound = true;
                                        ...
                                        component = new BlockNbtComponent(
                                            nbt, interpret, separator, obj.get("block").getAsString()
                                        );
                                        typeFound = true;
                                    }
                                } else {
                                    component = new EntityNbtComponent(
                                        nbt, interpret, separator, obj.get("entity").getAsString()
                                    );
                                    typeFound = true;
                                }
                                ...
                                if (!typeFound) {
                                    throw new IllegalArgumentException(
                                        "Unknown Nbt component type: " + obj.getClass().getSimpleName()
                                    );
                                }
                            } else {
