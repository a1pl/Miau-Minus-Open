...
public class NbtTextSerializer_v1_20_3 implements ITypedSerializer<Tag, ATextComponent>, CodecUtils_v1_20_3 {
    ...
    public NbtTextSerializer_v1_20_3(Function<NbtTextSerializer_v1_20_3, ITypedSerializer<Tag, Style>> styleSerializer) {
    ...
    protected Tag optimizeAndConvert(List<Tag> tags) {
    ...
    protected Tag getCommonType(List<Tag> tags) {
        if (tags.size() == 1) {
            return tags.get(0);
        }
    ...
    public ATextComponent deserialize(Tag object) {
        ...
        if (object instanceof ListTag) {
            ...
            ListTag<Tag> listTag = (ListTag<Tag>)object;
            ...
            if (!(tag.get("text") instanceof StringTag) || type != null && !type.equals("text")) {
                if (!(tag.get("translate") instanceof StringTag) || type != null && !type.equals("translatable")) {
                    if (!(tag.get("keybind") instanceof StringTag) || type != null && !type.equals("keybind")) {
                        if (!(tag.get("score") instanceof CompoundTag)
                            || !(
                                (tag.get("score") instanceof CompoundTag ? tag.get("score") : new CompoundTag())
                                    .get("name") instanceof StringTag
                            )
                            || !(
                                (tag.get("score") instanceof CompoundTag ? tag.get("score") : new CompoundTag())
                                    .get("objective") instanceof StringTag
                            )
                            ...
                            if (!(tag.get("selector") instanceof StringTag) || type != null && !type.equals("selector")
                                )
                             {
                                ...
                                String nbt = tag.get("nbt") instanceof StringTag
                                    ? tag.<StringTag>get("nbt").getValue()
                                    : "";
                                boolean interpret = tag.get("interpret") instanceof ByteTag
                                    ? tag.<ByteTag>get("interpret").asBoolean()
                                    : false;
                                ...
                                String source = tag.get("source") instanceof StringTag
                                    ? tag.<StringTag>get("source").getValue()
                                    : null;
                                boolean typeFound = false;
                                if (!(tag.get("entity") instanceof StringTag)
                                    || source != null && !source.equals("entity")) {
                                    if (!(tag.get("block") instanceof StringTag)
                                        || source != null && !source.equals("block")) {
                                        if (tag.get("storage") instanceof StringTag
                                            && (source == null || source.equals("storage"))) {
                                            try {
                                                component = new StorageNbtComponent(
                                                    ...
                                                    separator,
                                                    Identifier.of(
                                                        tag.get("storage") instanceof StringTag
                                                            ? tag.<StringTag>get("storage").getValue()
                                                            : ""
                                                    )
                                                );
                                                typeFound = true;
                                        ...
                                        component = new BlockNbtComponent(
                                            ...
                                            interpret,
                                            separator,
                                            tag.get("block") instanceof StringTag
                                                ? tag.<StringTag>get("block").getValue()
                                                : ""
                                        );
                                        typeFound = true;
                                    }
                                    ...
                                    component = new EntityNbtComponent(
                                        ...
                                        interpret,
                                        separator,
                                        tag.get("entity") instanceof StringTag
                                            ? tag.<StringTag>get("entity").getValue()
                                            : ""
                                    );
                                    typeFound = true;
                                }
                                ...
                                String selector = tag.get("selector") instanceof StringTag
                                    ? tag.<StringTag>get("selector").getValue()
                                    : "";
                                ATextComponent separator = null;
                                if (tag.contains("separator")) {
                                    separator = this.deserialize(tag.get("separator"));
                            ...
                            CompoundTag score = tag.get("score") instanceof CompoundTag
                                ? tag.get("score")
                                : new CompoundTag();
                            String name = score.get("name") instanceof StringTag
                                ? score.<StringTag>get("name").getValue()
                                : "";
                            String objective = score.get("objective") instanceof StringTag
                                ? score.<StringTag>get("objective").getValue()
                                : "";
                            component = new ScoreComponent(name, objective);
                        }
                    } else {
                        component = new KeybindComponent(
                            tag.get("keybind") instanceof StringTag ? tag.<StringTag>get("keybind").getValue() : ""
                        );
                    }
                } else {
                    String key = tag.get("translate") instanceof StringTag
                        ? tag.<StringTag>get("translate").getValue()
                        : "";
                    String fallback = tag.get("fallback") instanceof StringTag
                        ? tag.<StringTag>get("fallback").getValue()
                        : null;
                ...
                component = new StringComponent(
                    tag.get("text") instanceof StringTag ? tag.<StringTag>get("text").getValue() : ""
                );
            }
            ...
            if (tag.contains("extra")) {
                ...
                ListTag<Tag> extraTag = tag.get("extra") instanceof ListTag ? tag.get("extra") : new ListTag<>();
                if (extraTag.isEmpty()) {
