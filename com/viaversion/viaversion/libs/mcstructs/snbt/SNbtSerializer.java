...
public class SNbtSerializer<T extends Tag> {
    public static final SNbtSerializer<Tag> V1_7 = new SNbtSerializer<>(
        SNbtSerializer_v1_7::new, SNbtDeserializer_v1_7::new
    );
    public static final SNbtSerializer<CompoundTag> V1_8 = new SNbtSerializer<>(
        SNbtSerializer_v1_8::new, SNbtDeserializer_v1_8::new
    );
    public static final SNbtSerializer<CompoundTag> V1_12 = new SNbtSerializer<>(
        SNbtSerializer_v1_12::new, SNbtDeserializer_v1_12::new
    );
    public static final SNbtSerializer<CompoundTag> V1_13 = new SNbtSerializer<>(
        SNbtSerializer_v1_12::new, SNbtDeserializer_v1_13::new
    );
    public static final SNbtSerializer<CompoundTag> V1_14 = new SNbtSerializer<>(
        SNbtSerializer_v1_14::new, SNbtDeserializer_v1_14::new
    );
    ...
    public SNbtSerializer(
        Supplier<ISNbtSerializer> serializerSupplier, Supplier<ISNbtDeserializer<T>> deserializerSupplier
    ) {
