...
public class Int2IntOpenHashMap extends AbstractInt2IntMap implements Serializable, Cloneable, Hash {
    ...
    private final class EntryIterator
        extends Int2IntOpenHashMap.MapIterator<Consumer<? super Int2IntMap.Entry>>
    ...
    private final class KeyIterator
        extends Int2IntOpenHashMap.MapIterator<java.util.function.IntConsumer>
    ...
    final class MapEntry implements Int2IntMap.Entry, Entry<Integer, Integer>, IntIntPair {
        ...
        public boolean equals(Object o) {
            ...
            return Int2IntOpenHashMap.this.key[this.index] == e.getKey()
                && Int2IntOpenHashMap.this.value[this.index] == e.getValue();
        }
            ...
            if (e.getValue() != null && e.getValue() instanceof Integer) {
                ...
                if (k == 0) {
                    return Int2IntOpenHashMap.this.containsNullKey
                        && Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.n] == v;
                }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                int curr;
                for (pos = pos + 1 & Int2IntOpenHashMap.this.mask;
                    (curr = key[pos]) != 0;
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    Int2IntOpenHashMap.this.size - this.c,
                    (long)(
                            (double)Int2IntOpenHashMap.this.realSize()
                                / Int2IntOpenHashMap.this.n
                                * (this.max - this.pos)
                        )
