    ...
    private final class EntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntMap.FastEntrySet {
            ...
            return new ObjectIterator<Int2IntMap.Entry>() {
                ...
                public Int2IntMap.Entry next() {
                    if (!this.hasNext()) {
                        ...
                        return new AbstractInt2IntMap.BasicEntry(
                            Int2IntArrayMap.this.key[this.curr = this.next], Int2IntArrayMap.this.value[this.next++]
                        );
                    }
                }
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Int2IntArrayMap.this.value, this.next + 1, Int2IntArrayMap.this.value, this.next, tail
                    );
                }
                ...
                public void forEachRemaining(Consumer<? super Int2IntMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        action.accept(
                            new AbstractInt2IntMap.BasicEntry(
                                Int2IntArrayMap.this.key[this.curr = this.next],
                                Int2IntArrayMap.this.value[this.next++]
                            )
                        );
                    }
                }
        ...
        public void forEach(Consumer<? super Int2IntMap.Entry> action) {
            ...
            for (int max = Int2IntArrayMap.this.size; i < max; i++) {
                action.accept(
                    new AbstractInt2IntMap.BasicEntry(Int2IntArrayMap.this.key[i], Int2IntArrayMap.this.value[i])
                );
            }
        }
        ...
        final class EntrySetSpliterator
            ...
            protected final Int2IntMap.Entry get(int location) {
                return new AbstractInt2IntMap.BasicEntry(
                    Int2IntArrayMap.this.key[location], Int2IntArrayMap.this.value[location]
                );
            }
        ...
        public IntIterator iterator() {
            return new IntIterator() {
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Int2IntArrayMap.this.value, this.pos, Int2IntArrayMap.this.value, this.pos - 1, tail
                    );
                    Int2IntArrayMap.this.size--;
                    this.pos--;
                }
