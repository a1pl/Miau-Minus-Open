        ...
        return expectedSize <= 16
            ...
            : stream.collect(
                new IntCollections.SizeDecreasingSupplier<>(
                    expectedSize, size -> size <= 16 ? new IntOpenHashSet() : new IntOpenHashSet(size)
                ),
                IntOpenHashSet::add,
    ...
    private final class SetIterator implements IntIterator {
        ...
        private final void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                int curr;
                for (pos = pos + 1 & IntOpenHashSet.this.mask;
                    (curr = key[pos]) != 0;
    ...
    private final class SetSpliterator implements IntSpliterator {
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    IntOpenHashSet.this.size - this.c,
                    (long)((double)IntOpenHashSet.this.realSize() / IntOpenHashSet.this.n * (this.max - this.pos))
        ...
        public IntOpenHashSet.SetSpliterator trySplit() {
            ...
            int retPos = this.pos;
            int retMax = myNewPos;
            IntOpenHashSet.SetSpliterator split = IntOpenHashSet.this.new SetSpliterator(
