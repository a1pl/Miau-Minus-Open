            ...
            public int[] next() {
                ...
                if (this.i % IntArrayFrontCodedList.this.ratio == 0) {
                    ...
                    BigArrays.copyFromBig(
                        ...
                        this.pos + IntArrayFrontCodedList.count(length),
                        this.s,
                        0,
                        length
                    );
                    ...
                    length = IntArrayFrontCodedList.readInt(IntArrayFrontCodedList.this.array, this.pos);
                    int common = IntArrayFrontCodedList.readInt(
                        IntArrayFrontCodedList.this.array, this.pos + IntArrayFrontCodedList.count(length)
                    );
                    ...
                    this.pos = this.pos
                        + (IntArrayFrontCodedList.count(length) + IntArrayFrontCodedList.count(common) + length);
                    length += common;
                } else {
