...
public final class IntSpliterators {
    ...
    public static IntSpliterator wrapPreSorted(
        int[] array, int offset, int length, int additionalCharacteristics, IntComparator comparator
    ) {
        IntArrays.ensureOffsetLength(array, offset, length);
        return new IntSpliterators.ArraySpliteratorWithComparator(
    ...
    public static IntSpliterator asIntSpliterator(Spliterator i) {
        if (i instanceof IntSpliterator) {
            ...
            return i instanceof OfInt
                ? new IntSpliterators.PrimitiveSpliteratorWrapper((OfInt)i)
                : new IntSpliterators.SpliteratorWrapper(i);
        }
    }
    ...
    public static IntSpliterator asIntSpliterator(Spliterator i, IntComparator comparatorOverride) {
        if (i instanceof IntSpliterator) {
            throw new IllegalArgumentException(
                "Cannot override comparator on instance that is already a " + IntSpliterator.class.getSimpleName()
            );
        } else {
            return i instanceof OfInt
    ...
    public static void onEachMatching(
        IntSpliterator spliterator, java.util.function.IntPredicate predicate, java.util.function.IntConsumer action
    ) {
    ...
    public static IntSpliterator asSpliteratorFromSorted(
        IntIterator iter, long size, int additionalCharacterisitcs, IntComparator comparator
    ) {
        return new IntSpliterators.SpliteratorFromIteratorWithComparator(
    ...
    public static IntSpliterator asSpliteratorFromSortedUnknownSize(
        IntIterator iter, int additionalCharacterisitcs, IntComparator comparator
    ) {
    ...
    public abstract static class EarlyBindingSizeIndexBasedSpliterator
        extends IntSpliterators.AbstractIndexBasedSpliterator {
    ...
    public abstract static class LateBindingSizeIndexBasedSpliterator
        extends IntSpliterators.AbstractIndexBasedSpliterator {
    ...
    private static class PrimitiveSpliteratorWrapperWithComparator extends IntSpliterators.PrimitiveSpliteratorWrapper {
        ...
        public IntSpliterator trySplit() {
            ...
            return innerSplit == null
                ? null
                : new IntSpliterators.PrimitiveSpliteratorWrapperWithComparator(innerSplit, this.comparator);
        }
    }
    ...
    private static class SpliteratorFromIteratorWithComparator extends IntSpliterators.SpliteratorFromIterator {
        ...
        SpliteratorFromIteratorWithComparator(
            IntIterator iter, long size, int additionalCharacteristics, IntComparator comparator
        ) {
    ...
    private static class SpliteratorWrapperWithComparator extends IntSpliterators.SpliteratorWrapper {
        ...
        public IntSpliterator trySplit() {
            ...
            return innerSplit == null
                ? null
                : new IntSpliterators.SpliteratorWrapperWithComparator(innerSplit, this.comparator);
        }
    }
}
