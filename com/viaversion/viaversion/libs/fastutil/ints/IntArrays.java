        ...
        if (len < 16) {
            ...
            while (true) {
                ...
                while (b > c || (comparison = (t = Integer.compare(x[b], v)) == 0 ? Integer.compare(y[b], w) : t) > 0) {
                    for (;
                        c >= b
                            && (comparison = (t = Integer.compare(x[c], v)) == 0 ? Integer.compare(y[c], w) : t) >= 0;
                        c--
                    ) {
                        if (comparison == 0) {
                            swap(x, y, c, d--);
                ...
                while (true) {
                    ...
                    while (b > c || (comparison = Integer.compare(x[b], v)) > 0) {
                        ...
                        if (b > c) {
                            ...
                            if (s > 1 && comparison > 1) {
                                invokeAll(
                                    new IntArrays.ForkJoinQuickSort(x, this.from, this.from + s),
                                    new IntArrays.ForkJoinQuickSort(x, this.to - comparison, this.to)
                                );
                            } else if (s > 1) {
        ...
        protected void compute() {
            ...
            if (len < 8192) {
                ...
                while (true) {
                    ...
                    int t;
                    while (
                        b > c || (comparison = (t = Integer.compare(x[b], v)) == 0 ? Integer.compare(y[b], w) : t) > 0
                    ) {
                        for (;
                            c >= b
                                && (comparison = (t = Integer.compare(x[c], v)) == 0 ? Integer.compare(y[c], w) : t)
                                    >= 0;
                            c--
                        ) {
                            if (comparison == 0) {
