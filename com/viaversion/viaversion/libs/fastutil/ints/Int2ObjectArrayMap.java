    ...
    private final class EntrySet
        ...
        public ObjectIterator<Int2ObjectMap.Entry<V>> iterator() {
            return new ObjectIterator<Int2ObjectMap.Entry<V>>() {
                ...
                public Int2ObjectMap.Entry<V> next() {
                    if (!this.hasNext()) {
                        ...
                        return new AbstractInt2ObjectMap.BasicEntry<>(
                            Int2ObjectArrayMap.this.key[this.curr = this.next],
                            (V)Int2ObjectArrayMap.this.value[this.next++]
                        );
                    }
                }
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Int2ObjectArrayMap.this.key, this.next + 1, Int2ObjectArrayMap.this.key, this.next, tail
                    );
                    System.arraycopy(
                        Int2ObjectArrayMap.this.value, this.next + 1, Int2ObjectArrayMap.this.value, this.next, tail
                    );
                ...
                public void forEachRemaining(Consumer<? super Int2ObjectMap.Entry<V>> action) {
                    ...
                    while (this.next < max) {
                        action.accept(
                            new AbstractInt2ObjectMap.BasicEntry<>(
                                Int2ObjectArrayMap.this.key[this.curr = this.next],
                                (V)Int2ObjectArrayMap.this.value[this.next++]
                            )
                        );
        ...
        public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> action) {
            ...
            for (int max = Int2ObjectArrayMap.this.size; i < max; i++) {
                action.accept(
                    new AbstractInt2ObjectMap.BasicEntry<>(
                        Int2ObjectArrayMap.this.key[i], (V)Int2ObjectArrayMap.this.value[i]
                    )
                );
            }
        }
        ...
        public boolean remove(Object o) {
            ...
            if (e.getKey() != null && e.getKey() instanceof Integer) {
                ...
                if (oldPos != -1 && Objects.equals(v, Int2ObjectArrayMap.this.value[oldPos])) {
                    ...
                    System.arraycopy(
                        Int2ObjectArrayMap.this.value, oldPos + 1, Int2ObjectArrayMap.this.value, oldPos, tail
                    );
        ...
        final class EntrySetSpliterator
            ...
            protected final Int2ObjectMap.Entry<V> get(int location) {
                return new AbstractInt2ObjectMap.BasicEntry<>(
                    Int2ObjectArrayMap.this.key[location], (V)Int2ObjectArrayMap.this.value[location]
                );
            }
        ...
        public IntIterator iterator() {
            return new IntIterator() {
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Int2ObjectArrayMap.this.key, this.pos, Int2ObjectArrayMap.this.key, this.pos - 1, tail
                    );
                    System.arraycopy(
                        Int2ObjectArrayMap.this.value, this.pos, Int2ObjectArrayMap.this.value, this.pos - 1, tail
                    );
                    Int2ObjectArrayMap.this.size--;
                    this.pos--;
                    Int2ObjectArrayMap.this.value[Int2ObjectArrayMap.this.size] = null;
