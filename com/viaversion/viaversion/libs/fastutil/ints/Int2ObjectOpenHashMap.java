...
public class Int2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    private final class KeyIterator
        extends Int2ObjectOpenHashMap<V>.MapIterator<java.util.function.IntConsumer>
    ...
    final class MapEntry implements Int2ObjectMap.Entry<V>, Entry<Integer, V>, IntObjectPair<V> {
        ...
        public boolean equals(Object o) {
            ...
            return Int2ObjectOpenHashMap.this.key[this.index] == e.getKey()
        ...
        public int hashCode() {
            return Int2ObjectOpenHashMap.this.key[this.index]
                ^ (
                    Int2ObjectOpenHashMap.this.value[this.index] == null
                        ? 0
                        : Int2ObjectOpenHashMap.this.value[this.index].hashCode()
                );
        }
            ...
            if (e.getKey() != null && e.getKey() instanceof Integer) {
                ...
                if (k == 0) {
                    return Int2ObjectOpenHashMap.this.containsNullKey
                        && Objects.equals(Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.n], v);
                }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                int curr;
                for (pos = pos + 1 & Int2ObjectOpenHashMap.this.mask;
                    (curr = key[pos]) != 0;
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    Int2ObjectOpenHashMap.this.size - this.c,
                    (long)(
                            (double)Int2ObjectOpenHashMap.this.realSize()
                                / Int2ObjectOpenHashMap.this.n
                                * (this.max - this.pos)
                        )
    ...
    private final class ValueIterator
        extends Int2ObjectOpenHashMap<V>.MapIterator<Consumer<? super V>>
