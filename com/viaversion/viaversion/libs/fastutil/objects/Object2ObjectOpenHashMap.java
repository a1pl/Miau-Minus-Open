...
public class Object2ObjectOpenHashMap<K, V>
    ...
    private final class KeyIterator
        extends Object2ObjectOpenHashMap<K, V>.MapIterator<Consumer<? super K>>
    ...
    final class MapEntry implements Object2ObjectMap.Entry<K, V>, Entry<K, V>, Pair<K, V> {
        ...
        public int hashCode() {
            return (
                    Object2ObjectOpenHashMap.this.key[this.index] == null
                        ? 0
                        : Object2ObjectOpenHashMap.this.key[this.index].hashCode()
                )
                ^ (
                    Object2ObjectOpenHashMap.this.value[this.index] == null
                        ? 0
                        : Object2ObjectOpenHashMap.this.value[this.index].hashCode()
                );
        }
        ...
        public String toString() {
            return Object2ObjectOpenHashMap.this.key[this.index]
                + "=>"
                + Object2ObjectOpenHashMap.this.value[this.index];
        }
    }
    ...
    private final class MapEntrySet
        ...
        public boolean contains(Object o) {
            ...
            V v = (V)e.getValue();
            if (k == null) {
                return Object2ObjectOpenHashMap.this.containsNullKey
                    && Objects.equals(Object2ObjectOpenHashMap.this.value[Object2ObjectOpenHashMap.this.n], v);
            }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                K curr;
                for (pos = pos + 1 & Object2ObjectOpenHashMap.this.mask;
                    (curr = key[pos]) != null;
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    Object2ObjectOpenHashMap.this.size - this.c,
                    (long)(
                            (double)Object2ObjectOpenHashMap.this.realSize()
                                / Object2ObjectOpenHashMap.this.n
                                * (this.max - this.pos)
                        )
    ...
    private final class ValueIterator
        extends Object2ObjectOpenHashMap<K, V>.MapIterator<Consumer<? super V>>
