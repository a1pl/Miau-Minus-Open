...
public class Reference2ObjectOpenHashMap<K, V>
    ...
    private final class KeyIterator
        extends Reference2ObjectOpenHashMap<K, V>.MapIterator<Consumer<? super K>>
    ...
    final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Entry<K, V>, ReferenceObjectPair<K, V> {
        ...
        public int hashCode() {
            return System.identityHashCode(Reference2ObjectOpenHashMap.this.key[this.index])
                ^ (
                    Reference2ObjectOpenHashMap.this.value[this.index] == null
                        ? 0
                        : Reference2ObjectOpenHashMap.this.value[this.index].hashCode()
                );
        }
        ...
        public String toString() {
            return Reference2ObjectOpenHashMap.this.key[this.index]
                + "=>"
                + Reference2ObjectOpenHashMap.this.value[this.index];
        }
    }
    ...
    private final class MapEntrySet
        ...
        public boolean contains(Object o) {
            ...
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ObjectOpenHashMap.this.mask])
                == null) {
                return false;
            }
            ...
            if (k == null) {
                ...
                if ((
                        curr = key[pos = HashCommon.mix(System.identityHashCode(k))
                            & Reference2ObjectOpenHashMap.this.mask]
                    )
                    == null) {
                    return false;
                }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                K curr;
                for (pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask;
                    (curr = key[pos]) != null;
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    Reference2ObjectOpenHashMap.this.size - this.c,
                    (long)(
                            (double)Reference2ObjectOpenHashMap.this.realSize()
                                / Reference2ObjectOpenHashMap.this.n
                                * (this.max - this.pos)
                        )
    ...
    private final class ValueIterator
        extends Reference2ObjectOpenHashMap<K, V>.MapIterator<Consumer<? super V>>
