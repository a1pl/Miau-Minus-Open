        ...
        return new AbstractObjectSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Object2IntMap.Entry<K>> i = Object2IntMaps.fastIterator(
                        AbstractObject2IntMap.this
                    );
        ...
        public boolean equals(Object o) {
            if (!(o instanceof Entry)) {
                ...
                return value != null && value instanceof Integer
                    ? Objects.equals(this.key, key) && this.value == (Integer)value
                    : false;
            }
        }
    ...
    public abstract static class BasicEntrySet<K> extends AbstractObjectSet<Object2IntMap.Entry<K>> {
        ...
        public boolean contains(Object o) {
            if (!(o instanceof Entry)) {
                ...
                Object value = e.getValue();
                return value != null && value instanceof Integer
                    ? this.map.containsKey(k) && this.map.getInt(k) == (Integer)value
                    : false;
            }
        }
