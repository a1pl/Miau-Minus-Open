...
public class ReferenceOpenHashSet<K> extends AbstractReferenceSet<K> implements Serializable, Cloneable, Hash {
        ...
        return expectedSize <= 16
            ...
            : Collector.of(
                new ReferenceCollections.SizeDecreasingSupplier<>(
                    expectedSize, size -> size <= 16 ? new ReferenceOpenHashSet() : new ReferenceOpenHashSet(size)
                ),
    ...
    private final class SetIterator implements ObjectIterator<K> {
        ...
        private final void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                K curr;
                for (pos = pos + 1 & ReferenceOpenHashSet.this.mask;
                    (curr = key[pos]) != null;
    ...
    private final class SetSpliterator implements ObjectSpliterator<K> {
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    ReferenceOpenHashSet.this.size - this.c,
                    (long)(
                            (double)ReferenceOpenHashSet.this.realSize()
                                / ReferenceOpenHashSet.this.n
                                * (this.max - this.pos)
                        )
        ...
        public ReferenceOpenHashSet<K>.SetSpliterator trySplit() {
            ...
            int retPos = this.pos;
            int retMax = myNewPos;
            ReferenceOpenHashSet<K>.SetSpliterator split = ReferenceOpenHashSet.this.new SetSpliterator(
