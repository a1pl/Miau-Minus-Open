    ...
    private final class EntrySet
        ...
        public ObjectIterator<Object2IntMap.Entry<K>> iterator() {
            return new ObjectIterator<Object2IntMap.Entry<K>>() {
                ...
                public Object2IntMap.Entry<K> next() {
                    if (!this.hasNext()) {
                        ...
                        return new AbstractObject2IntMap.BasicEntry<>(
                            (K)Object2IntArrayMap.this.key[this.curr = this.next],
                            Object2IntArrayMap.this.value[this.next++]
                        );
                    }
                }
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Object2IntArrayMap.this.key, this.next + 1, Object2IntArrayMap.this.key, this.next, tail
                    );
                    System.arraycopy(
                        Object2IntArrayMap.this.value, this.next + 1, Object2IntArrayMap.this.value, this.next, tail
                    );
                ...
                public void forEachRemaining(Consumer<? super Object2IntMap.Entry<K>> action) {
                    ...
                    while (this.next < max) {
                        action.accept(
                            new AbstractObject2IntMap.BasicEntry<>(
                                (K)Object2IntArrayMap.this.key[this.curr = this.next],
                                Object2IntArrayMap.this.value[this.next++]
                            )
                        );
        ...
        public void forEach(Consumer<? super Object2IntMap.Entry<K>> action) {
            ...
            for (int max = Object2IntArrayMap.this.size; i < max; i++) {
                action.accept(
                    new AbstractObject2IntMap.BasicEntry<>(
                        (K)Object2IntArrayMap.this.key[i], Object2IntArrayMap.this.value[i]
                    )
                );
            }
        }
            ...
            if (!(o instanceof Entry)) {
                ...
                if (e.getValue() != null && e.getValue() instanceof Integer) {
                    ...
                    return Object2IntArrayMap.this.containsKey(k)
                        && Object2IntArrayMap.this.getInt(k) == (Integer)e.getValue();
                } else {
                    return false;
                }
            }
        ...
        public boolean remove(Object o) {
            ...
            if (e.getValue() != null && e.getValue() instanceof Integer) {
                ...
                if (oldPos != -1 && v == Object2IntArrayMap.this.value[oldPos]) {
                    ...
                    System.arraycopy(
                        Object2IntArrayMap.this.value, oldPos + 1, Object2IntArrayMap.this.value, oldPos, tail
                    );
        ...
        final class EntrySetSpliterator
            ...
            protected final Object2IntMap.Entry<K> get(int location) {
                return new AbstractObject2IntMap.BasicEntry<>(
                    (K)Object2IntArrayMap.this.key[location], Object2IntArrayMap.this.value[location]
                );
            }
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>() {
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Object2IntArrayMap.this.key, this.pos, Object2IntArrayMap.this.key, this.pos - 1, tail
                    );
                    System.arraycopy(
                        Object2IntArrayMap.this.value, this.pos, Object2IntArrayMap.this.value, this.pos - 1, tail
                    );
                    Object2IntArrayMap.this.size--;
                    this.pos--;
                    Object2IntArrayMap.this.key[Object2IntArrayMap.this.size] = null;
