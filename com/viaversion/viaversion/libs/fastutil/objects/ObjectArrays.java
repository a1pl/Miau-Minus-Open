        ...
        for (int i = from; i < to - 1; i++) {
            ...
            for (int j = i + 1; j < to; j++) {
                ...
                if ((u = ((Comparable)a[j]).compareTo(a[m])) < 0
                    || u == false && ((Comparable)b[j]).compareTo(b[m]) < 0) {
                    m = j;
                }
            }
        ...
        if (len < 16) {
            ...
            while (true) {
                ...
                while (
                    b > c
                        || (
                                comparison = (t = ((Comparable)x[b]).compareTo(v)) == 0
                    ...
                    for (;
                        c >= b
                            && (
                                    comparison = (t = ((Comparable)x[c]).compareTo(v)) == 0
                        ...
                        if (b > c) {
                            ...
                            if (s > 1 && comparison > 1) {
                                invokeAll(
                                    ...
                                    new ObjectArrays.ForkJoinQuickSortComp<>(
                                        x, this.to - comparison, this.to, this.comp
                                    )
                                );
                            } else if (s > 1) {
                                invokeAll(
                        ...
                        if (b > c) {
                            ...
                            if (s > 1 && comparison > 1) {
                                invokeAll(
                                    ...
                                    new ObjectArrays.ForkJoinQuickSortIndirect(
                                        this.perm, x, this.to - comparison, this.to
                                    )
                                );
                            } else if (s > 1) {
                                invokeAll(
