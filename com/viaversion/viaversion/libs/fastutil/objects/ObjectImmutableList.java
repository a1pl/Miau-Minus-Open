...
public class ObjectImmutableList<K>
        ...
        return expectedSize <= 10
            ...
            : Collector.of(
                new ObjectCollections.SizeDecreasingSupplier<>(
                    expectedSize, size -> size <= 10 ? new ObjectArrayList() : new ObjectArrayList(size)
                ),
                ObjectArrayList::add,
                ObjectArrayList::combine,
                ObjectImmutableList::convertTrustedToImmutableList
    ...
    public boolean equals(Object o) {
        if (o == this) {
            ...
            return o instanceof ObjectImmutableList.ImmutableSubList
                ? ((ObjectImmutableList.ImmutableSubList)o).equals(this)
                : super.equals(o);
        }
    }
