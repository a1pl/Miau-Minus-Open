...
public class ObjectIntImmutablePair<K> implements ObjectIntPair<K>, Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null) {
            ...
            return Objects.equals(this.left, ((ObjectIntPair)other).left())
                && this.right == ((ObjectIntPair)other).rightInt();
        } else {
            return !(other instanceof Pair)
                ? false
                : Objects.equals(this.left, ((Pair)other).left()) && Objects.equals(this.right, ((Pair)other).right());
        }
    }
