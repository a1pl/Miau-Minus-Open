...
import com.viaversion.viaversion.libs.fastutil.objects.ReferenceCollections.SynchronizedCollection;
import com.viaversion.viaversion.libs.fastutil.objects.ReferenceCollections.UnmodifiableCollection;
...
public final class ReferenceCollections {
    ...
    public static <K> ReferenceCollection<K> asCollection(ObjectIterable<K> iterable) {
        return iterable instanceof ReferenceCollection
