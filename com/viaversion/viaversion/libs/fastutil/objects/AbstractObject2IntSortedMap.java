...
public abstract class AbstractObject2IntSortedMap<K> extends AbstractObject2IntMap<K> implements Object2IntSortedMap<K> {
    ...
    protected class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public ObjectBidirectionalIterator<K> iterator(K from) {
            return new AbstractObject2IntSortedMap.KeySetIterator<>(
                AbstractObject2IntSortedMap.this.object2IntEntrySet()
                    .iterator(new AbstractObject2IntMap.BasicEntry<>(from, 0))
            );
        }
        ...
        public ObjectBidirectionalIterator<K> iterator() {
            return new AbstractObject2IntSortedMap.KeySetIterator<>(
                Object2IntSortedMaps.fastIterator(AbstractObject2IntSortedMap.this)
            );
        }
    }
    ...
    protected class ValuesCollection extends AbstractIntCollection {
        ...
        public IntIterator iterator() {
            return new AbstractObject2IntSortedMap.ValuesIterator<>(
                Object2IntSortedMaps.fastIterator(AbstractObject2IntSortedMap.this)
            );
        }
