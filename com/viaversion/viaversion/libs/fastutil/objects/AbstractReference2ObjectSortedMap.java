...
public abstract class AbstractReference2ObjectSortedMap<K, V>
    ...
    protected class KeySet extends AbstractReferenceSortedSet<K> {
        ...
        public ObjectBidirectionalIterator<K> iterator(K from) {
            return new AbstractReference2ObjectSortedMap.KeySetIterator<>(
                AbstractReference2ObjectSortedMap.this.reference2ObjectEntrySet()
                    .iterator(new AbstractReference2ObjectMap.BasicEntry<>(from, null))
            );
        }
    ...
    protected class ValuesCollection extends AbstractObjectCollection<V> {
        ...
        public ObjectIterator<V> iterator() {
            return new AbstractReference2ObjectSortedMap.ValuesIterator<>(
                Reference2ObjectSortedMaps.fastIterator(AbstractReference2ObjectSortedMap.this)
            );
        }
