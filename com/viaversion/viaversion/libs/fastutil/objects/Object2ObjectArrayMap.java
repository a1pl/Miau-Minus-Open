...
public class Object2ObjectArrayMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Serializable, Cloneable {
    ...
    private final class EntrySet
        ...
        public ObjectIterator<Object2ObjectMap.Entry<K, V>> iterator() {
            return new ObjectIterator<Object2ObjectMap.Entry<K, V>>() {
                ...
                public Object2ObjectMap.Entry<K, V> next() {
                    if (!this.hasNext()) {
                        ...
                        return new AbstractObject2ObjectMap.BasicEntry<>(
                            (K)Object2ObjectArrayMap.this.key[this.curr = this.next],
                            (V)Object2ObjectArrayMap.this.value[this.next++]
                        );
                    }
                }
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Object2ObjectArrayMap.this.key, this.next + 1, Object2ObjectArrayMap.this.key, this.next, tail
                    );
                    System.arraycopy(
                        Object2ObjectArrayMap.this.value,
                        this.next + 1,
                        Object2ObjectArrayMap.this.value,
                        this.next,
                        tail
        ...
        public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> action) {
            ...
            for (int max = Object2ObjectArrayMap.this.size; i < max; i++) {
                action.accept(
                    new AbstractObject2ObjectMap.BasicEntry<>(
                        (K)Object2ObjectArrayMap.this.key[i], (V)Object2ObjectArrayMap.this.value[i]
                    )
                );
            }
        }
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Entry)) {
                ...
                if (oldPos != -1 && Objects.equals(v, Object2ObjectArrayMap.this.value[oldPos])) {
                    ...
                    System.arraycopy(
                        Object2ObjectArrayMap.this.key, oldPos + 1, Object2ObjectArrayMap.this.key, oldPos, tail
                    );
                    System.arraycopy(
                        Object2ObjectArrayMap.this.value, oldPos + 1, Object2ObjectArrayMap.this.value, oldPos, tail
                    );
        ...
        final class EntrySetSpliterator
            ...
            protected final Object2ObjectMap.Entry<K, V> get(int location) {
                return new AbstractObject2ObjectMap.BasicEntry<>(
                    (K)Object2ObjectArrayMap.this.key[location], (V)Object2ObjectArrayMap.this.value[location]
                );
            }
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>() {
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Object2ObjectArrayMap.this.key, this.pos, Object2ObjectArrayMap.this.key, this.pos - 1, tail
                    );
                    System.arraycopy(
                        Object2ObjectArrayMap.this.value,
                        this.pos,
    ...
    private final class ValuesCollection extends AbstractObjectCollection<V> {
        ...
        final class ValuesSpliterator
            ...
            protected final Object2ObjectArrayMap<K, V>.ValuesCollection.ValuesSpliterator makeForSplit(
                int pos, int maxPos
            ) {
