...
public class ObjectObjectImmutableSortedPair<K extends Comparable<K>>
    ...
    public static <K extends Comparable<K>> ObjectObjectImmutableSortedPair<K> of(K left, K right) {
        return left.compareTo(right) <= 0
            ? new ObjectObjectImmutableSortedPair<>(left, right)
            : new ObjectObjectImmutableSortedPair<>(right, left);
    }
    ...
    public boolean equals(Object other) {
        if (other == null) {
            ...
            return !(other instanceof SortedPair)
                ? false
                : Objects.equals(this.left, ((SortedPair)other).left())
                    && Objects.equals(this.right, ((SortedPair)other).right());
        }
    }
