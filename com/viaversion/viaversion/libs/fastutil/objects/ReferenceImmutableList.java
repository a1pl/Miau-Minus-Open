...
public class ReferenceImmutableList<K>
        ...
        return expectedSize <= 10
            ...
            : Collector.of(
                new ReferenceCollections.SizeDecreasingSupplier<>(
                    expectedSize, size -> size <= 10 ? new ReferenceArrayList() : new ReferenceArrayList(size)
                ),
                ReferenceArrayList::add,
                ReferenceArrayList::combine,
                ReferenceImmutableList::convertTrustedToImmutableList
    ...
    public K get(int index) {
        if (index >= this.a.length) {
            throw new IndexOutOfBoundsException(
                "Index (" + index + ") is greater than or equal to list size (" + this.a.length + ")"
            );
        } else {
            return this.a[index];
        }
    ...
    public Object[] toArray() {
        if (this.a.length == 0) {
            ...
            return this.a.getClass() == Object[].class
                ? (Object[])this.a.clone()
                : Arrays.copyOf(this.a, this.a.length, Object[].class);
        }
    }
    ...
    public boolean equals(Object o) {
        if (o == this) {
            ...
            return o instanceof ReferenceImmutableList.ImmutableSubList
                ? ((ReferenceImmutableList.ImmutableSubList)o).equals(this)
                : super.equals(o);
        }
    }
    ...
    private static final class ImmutableSubList<K>
        ...
        private final class SubListSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> {
            ...
            protected final ReferenceImmutableList.ImmutableSubList<K>.SubListSpliterator makeForSplit(
                int pos, int maxPos
            ) {
