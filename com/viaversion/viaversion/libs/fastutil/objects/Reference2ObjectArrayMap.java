...
public class Reference2ObjectArrayMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable {
    ...
    private final class EntrySet
        ...
        public ObjectIterator<Reference2ObjectMap.Entry<K, V>> iterator() {
            return new ObjectIterator<Reference2ObjectMap.Entry<K, V>>() {
                ...
                public Reference2ObjectMap.Entry<K, V> next() {
                    if (!this.hasNext()) {
                        ...
                        return new AbstractReference2ObjectMap.BasicEntry<>(
                            (K)Reference2ObjectArrayMap.this.key[this.curr = this.next],
                            (V)Reference2ObjectArrayMap.this.value[this.next++]
                        );
                    }
                }
                ...
                public void remove() {
                    ...
                    System.arraycopy(
                        Reference2ObjectArrayMap.this.key,
                        this.next + 1,
                        Reference2ObjectArrayMap.this.key,
                        this.next,
                        tail
                    ...
                    System.arraycopy(
                        Reference2ObjectArrayMap.this.value,
                        this.next + 1,
                        Reference2ObjectArrayMap.this.value,
                        this.next,
                        tail
        ...
        public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> action) {
            ...
            for (int max = Reference2ObjectArrayMap.this.size; i < max; i++) {
                action.accept(
                    new AbstractReference2ObjectMap.BasicEntry<>(
                        (K)Reference2ObjectArrayMap.this.key[i], (V)Reference2ObjectArrayMap.this.value[i]
                    )
                );
            }
        }
        ...
        public boolean contains(Object o) {
            ...
            return Reference2ObjectArrayMap.this.containsKey(k)
                && Objects.equals(Reference2ObjectArrayMap.this.get(k), e.getValue());
        }
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Entry)) {
                ...
                if (oldPos != -1 && Objects.equals(v, Reference2ObjectArrayMap.this.value[oldPos])) {
                    ...
                    System.arraycopy(
                        Reference2ObjectArrayMap.this.key, oldPos + 1, Reference2ObjectArrayMap.this.key, oldPos, tail
                    );
                    System.arraycopy(
                        Reference2ObjectArrayMap.this.value,
                        oldPos + 1,
        ...
        final class EntrySetSpliterator
            ...
            protected final Reference2ObjectArrayMap<K, V>.EntrySet.EntrySetSpliterator makeForSplit(
                int pos, int maxPos
            ) {
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public boolean remove(Object k) {
            ...
            System.arraycopy(
                Reference2ObjectArrayMap.this.value, oldPos + 1, Reference2ObjectArrayMap.this.value, oldPos, tail
            );
            Reference2ObjectArrayMap.this.size--;
            Reference2ObjectArrayMap.this.key[Reference2ObjectArrayMap.this.size] = null;
            Reference2ObjectArrayMap.this.value[Reference2ObjectArrayMap.this.size] = null;
    ...
    private final class ValuesCollection extends AbstractObjectCollection<V> {
        ...
        public ObjectSpliterator<V> spliterator() {
            return new Reference2ObjectArrayMap.ValuesCollection.ValuesSpliterator(
                0, Reference2ObjectArrayMap.this.size
            );
        }
        ...
        final class ValuesSpliterator
            ...
            protected final Reference2ObjectArrayMap<K, V>.ValuesCollection.ValuesSpliterator makeForSplit(
                int pos, int maxPos
            ) {
