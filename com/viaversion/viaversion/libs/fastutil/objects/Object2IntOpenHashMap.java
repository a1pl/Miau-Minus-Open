...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
    ...
    private final class KeyIterator
        extends Object2IntOpenHashMap<K>.MapIterator<Consumer<? super K>>
    ...
    final class MapEntry implements Object2IntMap.Entry<K>, Entry<K, Integer>, ObjectIntPair<K> {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(Object2IntOpenHashMap.this.key[this.index], e.getKey())
                && Object2IntOpenHashMap.this.value[this.index] == e.getValue();
        }

        @Override
        public int hashCode() {
            return (
                    Object2IntOpenHashMap.this.key[this.index] == null
                        ? 0
                        : Object2IntOpenHashMap.this.key[this.index].hashCode()
                )
            ...
            if (e.getValue() != null && e.getValue() instanceof Integer) {
                ...
                if (k == null) {
                    return Object2IntOpenHashMap.this.containsNullKey
                        && Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n] == v;
                }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                K curr;
                for (pos = pos + 1 & Object2IntOpenHashMap.this.mask;
                    (curr = key[pos]) != null;
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    Object2IntOpenHashMap.this.size - this.c,
                    (long)(
                            (double)Object2IntOpenHashMap.this.realSize()
                                / Object2IntOpenHashMap.this.n
                                * (this.max - this.pos)
                        )
