        ...
        return expectedSize <= 16
            ...
            : Collector.of(
                new ObjectCollections.SizeDecreasingSupplier<>(
                    expectedSize, size -> size <= 16 ? new ObjectOpenHashSet() : new ObjectOpenHashSet(size)
                ),
    ...
    private final class SetIterator implements ObjectIterator<K> {
        ...
        private final void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                K curr;
                for (pos = pos + 1 & ObjectOpenHashSet.this.mask;
                    (curr = key[pos]) != null;
    ...
    private final class SetSpliterator implements ObjectSpliterator<K> {
        ...
        public long estimateSize() {
            return !this.hasSplit
                ...
                : Math.min(
                    ObjectOpenHashSet.this.size - this.c,
                    (long)((double)ObjectOpenHashSet.this.realSize() / ObjectOpenHashSet.this.n * (this.max - this.pos))
        ...
        public ObjectOpenHashSet<K>.SetSpliterator trySplit() {
            ...
            int retPos = this.pos;
            int retMax = myNewPos;
            ObjectOpenHashSet<K>.SetSpliterator split = ObjectOpenHashSet.this.new SetSpliterator(
                retPos, retMax, this.mustReturnNull, true
            );
            this.pos = myNewPos;
            this.mustReturnNull = false;
            this.hasSplit = true;
