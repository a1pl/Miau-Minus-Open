...
public final class Gson {
    ...
    Gson(
        ...
        factories.add(
            TypeAdapters.newFactory(double.class, Double.class, this.doubleAdapter(serializeSpecialFloatingPointValues))
        );
        factories.add(
            TypeAdapters.newFactory(float.class, Float.class, this.floatAdapter(serializeSpecialFloatingPointValues))
        );
        ...
        factories.add(
            new ReflectiveTypeAdapterFactory(
                this.constructorConstructor, fieldNamingStrategy, excluder, this.jsonAdapterFactory, reflectionFilters
            )
        );
