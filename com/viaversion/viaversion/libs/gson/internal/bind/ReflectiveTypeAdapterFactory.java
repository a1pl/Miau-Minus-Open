...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
        ...
        ReflectionAccessFilter.FilterResult filterResult = ReflectionAccessFilterHelper.getFilterResult(
            this.reflectionFilters, raw
        );
        ...
        return new ReflectiveTypeAdapterFactory.FieldReflectionAdapter<>(
            constructor, this.getBoundFields(gson, type, raw, blockInaccessible, false)
        );
    }
    ...
    private ReflectiveTypeAdapterFactory.BoundField createBoundField(
        ...
        if (annotation != null) {
            mapped = this.jsonAdapterFactory
                .getTypeAdapter(this.constructorConstructor, context, fieldType, annotation);
        }
                ...
                if (this.serialized) {
                    ...
                    if (accessor != null) {
                        try {
                            ...
                            String accessorDescription = ReflectionHelper.getAccessibleObjectDescription(
                                accessor, false
                            );
                            throw new JsonIOException(
                    ...
                    if (fieldValue != source) {
                        ...
                        TypeAdapter<Object> t = jsonAdapterPresent
                            ? typeAdapter
                    ...
                    if (isRecord) {
                        if (Modifier.isStatic(field.getModifiers())) {
                            ...
                            if (accessor.getAnnotation(SerializedName.class) != null
                                ...
                                String methodDescription = ReflectionHelper.getAccessibleObjectDescription(
                                    accessor, false
                                );
                                throw new JsonIOException(
