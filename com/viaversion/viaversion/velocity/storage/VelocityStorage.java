...
public class VelocityStorage implements StorableObject {
    ...
    public boolean equals(Object o) {
        ...
        if (o != null && this.getClass() == o.getClass()) {
            ...
            if (!Objects.equals(this.player, that.player)) {
                ...
                return !Objects.equals(this.currentServer, that.currentServer)
                    ? false
                    : Objects.equals(this.cachedBossbar, that.cachedBossbar);
            }
        } else {
            return false;
        }
    ...
    static {
        try {
            clientPlaySessionHandler = Class.forName(
            ...
            Via.getPlatform()
                .getLogger()
                .log(Level.SEVERE, "Failed to initialize Velocity bossbar support, bossbars will not work.", e);
        }
    }
}
