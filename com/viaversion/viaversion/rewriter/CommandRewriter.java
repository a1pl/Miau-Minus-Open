...
public class CommandRewriter<C extends ClientboundPacketType> {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        if (nodeType == 2) {
                            ...
                            Preconditions.checkNotNull(
                                newArgumentType, "No mapping for argument type %s", new Object[]{argumentType}
                            );
    ...
    public String handleArgumentType(String argumentType) {
        return this.protocol.getMappingData() != null
                && this.protocol.getMappingData().getArgumentTypeMappings() != null
