...
public class MetaFilter {
    ...
    public MetaFilter(
        @Nullable EntityType type, boolean filterFamily, @Nullable MetaType metaType, int index, MetaHandler handler
    ) {
    ...
    public boolean isFiltered(@Nullable EntityType type, Metadata metadata) {
        return (this.index == -1 || metadata.id() == this.index)
            && (this.type == null || this.matchesType(type))
    ...
    public boolean equals(Object o) {
        ...
        if (o != null && this.getClass() == o.getClass()) {
            ...
            if (this.index != that.index) {
                ...
                return !Objects.equals(this.metaType, that.metaType) ? false : Objects.equals(this.type, that.type);
            }
        } else {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public MetaFilter.Builder metaType(MetaType metaType) {
        ...
        public MetaFilter.Builder exactType(EntityType type) {
            Preconditions.checkArgument(this.type == null);
            this.type = type;
