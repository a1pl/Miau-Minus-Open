...
public class WorldPackets1_8 {
    public static void register(Protocol1_7_6_10To1_8 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_8.BLOCK_CHANGE, new PacketHandlers() {
            ...
            protected void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    wrapper.write(Type.VAR_INT, IdAndData.getId(data));
                    wrapper.write(Type.UNSIGNED_BYTE, (short)IdAndData.getData(data));
                });
            }
        });
        protocol.registerClientbound(
            ClientboundPackets1_8.MULTI_BLOCK_CHANGE,
            new PacketHandlers() {
                @Override
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            for (BlockChangeRecord record : records) {
                                wrapper.write(
                                    Type.SHORT,
                                    (short)(record.getSectionX() << 12 | record.getSectionZ() << 8 | record.getY())
                                );
                                wrapper.write(
                                    Type.SHORT, (short)protocol.getItemRewriter().handleBlockId(record.getBlockId())
                                );
                            }
                        }
                    );
                    ...
                    this.handler(
                        wrapper -> {
                            ...
                            if (particle == ParticleIndex1_7_6_10.ICON_CRACK
                                ...
                                int data = particle == ParticleIndex1_7_6_10.ICON_CRACK
        ...
        protocol.registerClientbound(
            ClientboundPackets1_8.MAP_DATA,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.handler(
                        wrapper -> {
                            ...
                            if (columns > 0) {
                                ...
                                for (int column = 0; column < columns; column++) {
                                    ...
                                    PacketWrapper mapData = PacketWrapper.create(
                                        ClientboundPackets1_8.MAP_DATA, wrapper.user()
                                    );
