                        ...
                        if (scoreboard.getColorIndependentSidebar() != null) {
                            ...
                            if (color.isPresent()) {
                                ...
                                if (name.equals(sidebar)) {
                                    PacketWrapper sidebarPacket = PacketWrapper.create(61, null, wrapper.user());
                                    sidebarPacket.write(Type.BYTE, (byte)1);
                                    sidebarPacket.write(Type.STRING, scoreboard.getColorIndependentSidebar());
                                    sidebarPacket.scheduleSend(Protocol1_7_6_10To1_8.class);
                                }
                            }
                        }
                            ...
                            if (team == null) {
                                ...
                                if (mode != 0 && !scoreboard.teamExists(team)) {
                                    ...
                                    if (mode == 0 && scoreboard.teamExists(team)) {
                                        ...
                                        PacketWrapper remove = PacketWrapper.create(62, null, wrapper.user());
                                        remove.write(Type.STRING, team);
                                        remove.write(Type.BYTE, (byte)1);
                                        remove.send(Protocol1_7_6_10To1_8.class);
                                    }
                                    ...
                                    if (mode == 0 || mode == 2) {
                                        ...
                                        if (mode == 2 && scoreboard.getTeamColor(team).get() != color) {
                                            ...
                                            PacketWrapper sidebarPacket = wrapper.create(61);
                                            sidebarPacket.write(Type.BYTE, (byte)1);
                                        ...
                                        for (String entry : entries) {
                                            ...
                                            if (mode == 4) {
                                                ...
                                                if (entry.equals(username)) {
                                                    ...
                                                    sidebarPacket.write(
                                                        Type.STRING,
                                                        scoreboard.getColorIndependentSidebar() == null
                                                            ? ""
                                                            : scoreboard.getColorIndependentSidebar()
                                                    );
                                                    sidebarPacket.scheduleSend(Protocol1_7_6_10To1_8.class);
                                                }
                                            } else {
                                                ...
                                                if (entry.equals(username)
                                                    && scoreboard.getColorDependentSidebar().containsKey(color)) {
                                                    PacketWrapper displayObjective = wrapper.create(61);
                                                    displayObjective.write(Type.BYTE, (byte)1);
                                                    displayObjective.write(
                                                        Type.STRING, scoreboard.getColorDependentSidebar().get(color)
                                                    );
                                                    displayObjective.scheduleSend(Protocol1_7_6_10To1_8.class);
                                                }
                                            }
