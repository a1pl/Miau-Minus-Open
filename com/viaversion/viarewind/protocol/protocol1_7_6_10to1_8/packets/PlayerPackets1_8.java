...
public class PlayerPackets1_8 {
    public static void register(Protocol1_7_6_10To1_8 protocol) {
        ...
        protocol.registerClientbound(
            ClientboundPackets1_8.GAME_EVENT,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.UNSIGNED_BYTE);
                                ...
                                if (gameMode == 3 || tracker.isSpectator()) {
                                    ...
                                    if (gameMode == 3) {
                                        ...
                                        for (int i = 0; i < equipment.length; i++) {
                                            equipment[i] = wrapper.user()
                                                .get(PlayerSessionStorage.class)
                                                .getPlayerEquipment(myId, i);
                                        }
                                    }

                                    for (int i = 0; i < equipment.length; i++) {
                                        PacketWrapper setSlot = PacketWrapper.create(
                                            ClientboundPackets1_7_2_5.SET_SLOT, wrapper.user()
                                        );
                                ...
                                if (action == 0) {
                                    ...
                                    while (propertyCount-- > 0) {
                                        ...
                                        gameProfile.properties
                                            .add(
                                                new GameProfileStorage.Property(
                                                    propertyName, propertyValue, propertySignature
                                                )
                                            );
                                    }
                                    ...
                                    PacketWrapper packet = PacketWrapper.create(
                                        ClientboundPackets1_7_2_5.PLAYER_INFO, null, wrapper.user()
                                    );
                                        ...
                                        if (gamemode == 3 || gameProfile.gamemode == 3) {
                                            ...
                                            if (entityId != -1) {
                                                ...
                                                for (short slot = 0; slot < equipment.length; slot++) {
                                                    PacketWrapper equipmentPacket = PacketWrapper.create(
                                                    ...
                                                    equipmentPacket.write(
                                                        Types1_7_6_10.COMPRESSED_NBT_ITEM, equipment[slot]
                                                    );
                                    ...
                                    String displayName = displayNameComponent != null
                                        ? ChatUtil.jsonToLegacy(wrapper.user(), displayNameComponent)
                                        : null;
                                    GameProfileStorage.GameProfile gameProfile = gameProfileStorage.get(uuid);
        ...
        protocol.registerClientbound(
            ClientboundPackets1_8.PLUGIN_MESSAGE,
            new PacketHandlers() {
                @Override
                public void register() {
                        ...
                        wrapper -> {
                            ...
                            if (channel.equals("MC|TrList")) {
                                ...
                                for (int i = 0; i < size; i++) {
                                    Item item = protocol.getItemRewriter()
                                        .handleItemToClient(wrapper.user(), wrapper.read(Type.ITEM1_8));
                                    wrapper.write(Types1_7_6_10.COMPRESSED_NBT_ITEM, item);
                                    item = protocol.getItemRewriter()
                                        .handleItemToClient(wrapper.user(), wrapper.read(Type.ITEM1_8));
                                    wrapper.write(Types1_7_6_10.COMPRESSED_NBT_ITEM, item);
                                ...
                                wrapper.write(
                                    Type.REMAINING_BYTES, wrapper.read(Type.STRING).getBytes(StandardCharsets.UTF_8)
                                );
                            }
                            ...
                            PacketWrapper newWrapper = PacketWrapper.create(
                                ClientboundPackets1_7_2_5.PLUGIN_MESSAGE, newPacketBuf, wrapper.user()
                            );
            ...
            new PacketHandlers() {
                ...
                public void register() {
                    this.handler(
                        wrapper -> {
                            wrapper.cancel();
                            TitleRenderProvider titleRenderProvider = Via.getManager()
                                .getProviders()
                                .get(TitleRenderProvider.class);
                            if (titleRenderProvider != null) {
                                ...
                                switch (action) {
                                    ...
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        titleRenderProvider.setTimings(
                                            uuid,
                                            wrapper.read(Type.INT),
                                            wrapper.read(Type.INT),
                                            wrapper.read(Type.INT)
        ...
        protocol.registerClientbound(
            ClientboundPackets1_8.RESOURCE_PACK, ClientboundPackets1_7_2_5.PLUGIN_MESSAGE, new PacketHandlers() {
                @Override
                public void register() {
        ...
        protocol.registerServerbound(ServerboundPackets1_7_2_5.CHAT_MESSAGE, new PacketHandlers() {
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (tracker.isSpectator() && msg.toLowerCase().startsWith("/stp ")) {
                        ...
                        if (profile != null && profile.uuid != null) {
                            wrapper.cancel();
                            PacketWrapper teleportPacket = PacketWrapper.create(24, null, wrapper.user());
        ...
        protocol.registerServerbound(
            ServerboundPackets1_7_2_5.INTERACT_ENTITY,
            new PacketHandlers() {
                @Override
                public void register() {
                        ...
                        wrapper -> {
                            ...
                            if (mode == 0) {
                                ...
                                if (tracker.getHolograms().containsKey(entityId)) {
                                    AABB boundingBox = tracker.getHolograms().get(entityId).getBoundingBox();
                                    Vector3d pos = new Vector3d(
                                        position.getPosX(), position.getPosY() + 1.8, position.getPosZ()
                                    );
        ...
        protocol.registerServerbound(ServerboundPackets1_7_2_5.ANIMATION, new PacketHandlers() {
            ...
            public void register() {
                this.handler(wrapper -> {
                    ...
                    int animation = wrapper.read(Type.BYTE);
                    if (animation != 1) {
                        wrapper.cancel();
                        byte var4;
                        switch (animation) {
                        ...
                        PacketWrapper entityAction = PacketWrapper.create(11, null, wrapper.user());
        ...
        protocol.registerServerbound(
            ServerboundPackets1_7_2_5.ENTITY_ACTION,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.INT, Type.VAR_INT);
                    this.handler(wrapper -> wrapper.write(Type.VAR_INT, wrapper.read(Type.BYTE) - 1));
                    this.map(Type.INT, Type.VAR_INT);
                    this.handler(
                        wrapper -> {
                            ...
                            if (action == 3 || action == 4) {
                                ...
                                PacketWrapper abilitiesPacket = PacketWrapper.create(57, null, wrapper.user());
                                abilitiesPacket.write(Type.BYTE, playerSession.combineAbilities());
                                abilitiesPacket.write(
                                    Type.FLOAT,
                                    playerSession.sprinting ? playerSession.flySpeed * 2.0F : playerSession.flySpeed
                                );
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (unmount) {
                        EntityTracker1_8 tracker = wrapper.user().getEntityTracker(Protocol1_7_6_10To1_8.class);
                        if (tracker.spectatingClientEntityId != tracker.clientEntityId()) {
                            PacketWrapper sneakPacket = PacketWrapper.create(11, null, wrapper.user());
                            sneakPacket.write(Type.VAR_INT, tracker.clientEntityId());
                            sneakPacket.write(Type.VAR_INT, 0);
                            sneakPacket.write(Type.VAR_INT, 0);
                            PacketWrapper unsneakPacket = PacketWrapper.create(11, null, wrapper.user());
                ...
                this.handler(wrapper -> {
                    ...
                    if (msg.toLowerCase().startsWith("/stp ")) {
                        ...
                        if (args.length <= 2) {
                            ...
                            PacketWrapper tabComplete = PacketWrapper.create(58, null, wrapper.user());
        ...
        protocol.registerServerbound(
            ServerboundPackets1_7_2_5.PLUGIN_MESSAGE,
            new PacketHandlers() {
                @Override
                public void register() {
                    this.map(Type.STRING);
                        ...
                        wrapper -> {
                            ...
                            switch (channel) {
                                ...
                                case "MC|ItemName":
                                    ...
                                    PacketWrapper updateCost = PacketWrapper.create(49, null, wrapper.user());
                                ...
                                case "MC|Brand":
                                    wrapper.write(
                                        Type.STRING,
                                        new String(wrapper.read(Type.REMAINING_BYTES), StandardCharsets.UTF_8)
                                    );
                            }
                        }
                    );
